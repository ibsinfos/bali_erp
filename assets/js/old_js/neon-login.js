			...
			{  
				...
				*/
				...
				setTimeout(function()
				{
                    ...
                    $.ajax({
						url: myJsMain.baseURL + 'index.php?ajax_controller/ajax_login',
						method: 'POST',
						dataType: 'json',
						data: {
						...
						success: function(response)
						{
							...
							var login_failed = response.login_failed;
							//alert(login_failed)
							...
							setTimeout(function()
							{
								...
								if(login_status == 'invalid')
								{
									...
									myJsMain.commonFunction.sharadAlert("Sharad Technologies Information","Invalid User Id and Password.Please try again");
								}
								else if(login_status == 'success')
								{
									//console.log(response);return false;
									var redirect_url = myJsMain.baseURL;
