...
<head>
    ...
    <style>
        ...
        * { margin: 0; padding: 0; }
        ...
        /*#logo { text-align: center;  position: relative; margin-top: 25px; border: 1px solid #fff; max-width: 540px; overflow: hidden; }*/
    ...
    <table width="100%">
        <tr>
            <td style="border: 0;  text-align: left;" width="62%">
                <span style="font-size: 20px; color: #2f4f4f"><strong><?php echo $_L['INVOICE']; ?> # <?php
                        if($d['cn'] != ''){
                            $dispid = $d['cn'];
                        }
                        else{
            ...
            <td  style="border: 0; width:300px;">                
                <div id="logo" style="text-align: center;">
                    <img id="image" src="<?php echo APP_URL; ?>/sysfrm/uploads/system/logo.png" width="140" height="40"  alt="logo" /> <br> <br>                   
                                           
                </div>
            </td>
            
            <td  style="border: 0;margin-top: 15cm" width="62%">
                <div class="col-sm-6 text-right mt-md mb-md"><span class="pull-right" style="font-size:22.5px;">
