...
<div id="page-wrap">
    ...
    <table width="100%">
        <tr>
            <td style="border: 0;  text-align: left" width="15%">
            ...
            <td style="border: 0;  text-align: left" width="45%">
                <span style=" font-weight: bold;font-size: 15px;">
                    English Reg No: <?php echo $customRowEngRegNo[0];?><br />
                    Hindi Reg No : <?php echo $customRowHindiRegNo[0];?>
                </span>
            </td>
            <td style="border: 0;  text-align: right" width="40%"><div id="logo" style="font-size:18px">
            ...
            <tr>
                <td rowspan="3" style="border: 1px solid white; border-right: 1px solid black; text-align: left" width="62%">
                    ...
                    <?php if($a['company'] != '') {
                       ...
                       <?php echo 'Student Name';//$_L['ATTN']; ?>: <?php echo $a['account']; ?> <br>
                    <?php
                    }
                    else{
                        ?>
                    ...
                    <?php echo $a['address'].', '.$a['city'].', '.$a['state']; ?>  <br>
                    <?php /*; ?> <?php echo $a['state']; ?> <?php echo $a['zip']; ?> <br>
                ...
                <td><?php echo 'DA/AC/'.$d['invoicenum'].$dispid; ?></td>
            </tr>
            <?php /*<tr>
    ...
    <table id="items">
        ...
        foreach ($items as $item){
            ...
            <td class="description">'.ucwords(strtolower($item['description'])).'</td>
        ...
        if($d['credit'] != '0.00'){
            ...
            <tr>
                <td class="blank"> </td>
                <td colspan="2" class="total-line"><?php echo 'Total'; ?></td>
...
<table width="100%">
    ...
    <table id="items">
        ...
        if($d['credit'] != '0.00'){
            ...
            <tr>
                <td class="blank"> </td>
                <td colspan="2" class="total-line"><?php echo $_L['Total']; ?></td>
                <td class="total-value"><div class="due"><?php echo $config['currency_code']; ?> <?php echo number_format($d['total'],2,$config['dec_point'],$_c['thousands_sep']);; ?></div></td>
            </tr>
            <?php /*<tr>
                <td class="blank"> </td>
