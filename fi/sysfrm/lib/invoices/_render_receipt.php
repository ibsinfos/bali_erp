...
<?php $rcpt= ucfirst('receipt');$RunningYear?>
<body>
<div id="page-wrap">
    <table width="100%">
        <tr>
            <td style="border: 0;  text-align: left" width="23%">
                <img id="image" src="<?php echo APP_URL; ?>/sysfrm/uploads/system/logo.png"  width="40" height="40"  alt="logo" />
                <?php /*<br><br>
            ...
            <td style="border: 0;  text-align: right" width="37%">
                <div id="logo" style="font-size:18px"><?php echo $config['caddress'];?></div>
            </td>
        </tr>
    </table>
    <hr>
    ...
    <div id="customer">
        <table id="meta">
            <tr>
                ...
                <td><?php echo 'DA/'.$invoiceRunningYear.'/'.$d['invoicenum'].$dispid; ?></td>
            </tr>
            <tr>
                <td class="meta-head"><?php echo 'Admission No';//$_L['Due Date']; ?></td>
                <td><?php echo $studentEnroleCode;//date($config['df'], strtotime($d['duedate'])); ?></td>
            </tr>
            <tr>
    ...
    <table id="items">
        ...
        ?>
            ...
            <?php /*<tr>
                <td class="blank"> </td>
                <td colspan="1" class="total-line"><?php echo $_L['Sub Total']; ?></td>
           ...
           ?>
            <tr>
                <td class="blank"> </td>
                <td colspan="1" class="total-line"><?php echo $_L['Discount']; ?>
                    <?php
        ...
        if (($d['tax']) != '0.00'){
            ...
            <tr>
                ...
                <td class="blank"> </td>
                <td colspan="1" class="total-line"><?php echo $_L['TAX']; ?></td>
        ...
        <?php if($d['credit'] != '0.00'){?>
            ...
            <tr>
                <td class="blank"> </td>
                <td colspan="1" class="total-line"><?php echo 'Total'; ?></td>
            ...
            <tr>
                <td class="blank"> </td>
                <td colspan="1" class="total-line"><?php echo $_L['Total Paid']; ?></td>
            ...
            <tr>
                <td class="blank"> </td>
                <td colspan="1" class="total-line balance"><?php echo $_L['Amount Due']; ?></td>
        ...
        <?php
            ...
            <tr>
                <td class="blank"> </td>
                <td colspan="1" class="total-line balance"><?php echo $_L['Grand Total']; ?></td>
...
<table width="100%">
        <tr>
            ...
            <td style="border: 0;  text-align: right" width="37%"><div id="logo" style="font-size:18px">
    ...
    <table id="items">
        ...
        <?php if($d['credit'] != '0.00'){?>
            <tr>
                <td class="blank"> </td>
                <td colspan="1" class="total-line"><?php echo $_L['Total']; ?></td>
                <td class="total-value"><div class="due"><?php echo $config['currency_code']; ?> <?php echo number_format($d['total'],2,$config['dec_point'],$_c['thousands_sep']);; ?></div></td>
            </tr>
            <tr>
                <td class="blank"> </td>
