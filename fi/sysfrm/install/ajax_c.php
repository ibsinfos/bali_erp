...
';
    ...
    $f_msg = 'Can\'t create config file. The folder is not writable. You will have to manually create config file. Create a <strong>config.php</strong> inside- <strong>sysfrm</strong> folder with following contents- <hr>
...
';
    ...
    if(file_exists($wConfig)){
        echo 'Config file exist. Please delete- <strong>sysfrm/config.php</strong> and try again.';
        exit;
    }
