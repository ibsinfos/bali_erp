            ...
            <div class="invoice">
                ...
                <header class="clearfix">
                    <div class="row">
                        ...
                        <div class="col-sm-8 text-right mt-md mb-md" style="margin-top:10px;">
                            <div class="ib">
                                <img src="{$app_url}sysfrm/uploads/system/logo.png"  width="70" height="70"  alt="Logo">
                            </div>
                            <address class="ib mr-xlg" style="margin-top:10px;">
                                <h3>{$_c['caddress']}</h3>
                            </address>
                        ...
                        <div class="col-sm-4 col-sm-offset-8">
                            <table class="table h5 text-dark">
                                ...
                                {if ($d['discount']) neq '0.00'}
                                    <tr>
                                        <td colspan="2">{'Scholarship Discount'}{*$_L['Discount']*}
