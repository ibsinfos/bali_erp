    ...
    <div class="col-lg-12 col-md-12 col-sm-12">
        <div class="ibox float-e-margins">
            <div class="ibox-title">
                <h5>{'Invoice Reports'} </h5>

            </div>
            <div class="ibox-content">
                <h4>{'Invoice Summary'}</h4>
                <hr>
                <h5>{'Total Invoice'}: {$_c['currency_code']} {number_format($a,2,$_c['dec_point'],$_c['thousands_sep'])}</h5>
                <h5>{'Total Invoice This Month'}: {$_c['currency_code']} {number_format($m,2,$_c['dec_point'],$_c['thousands_sep'])}</h5>
                <h5>{'Total Invoice This Week'}: {$_c['currency_code']} {number_format($w,2,$_c['dec_point'],$_c['thousands_sep'])}</h5>
                <h5>{'Total Invoice Last 30 days'}: {$_c['currency_code']} {number_format($m3,2,$_c['dec_point'],$_c['thousands_sep'])}</h5>
                <hr>
                <h4>{'Last 20 Invoice'}</h4>
                <hr>
