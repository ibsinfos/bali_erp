    ...
    <div class="panel panel-default" id="ibox_panel">
            ...
            <div class="panel-body">
                <div class="thumb-info mb-md">
                    ...
                    {else}
                        <img src="{$app_url}sysfrm/uploads/user-pics/{$d['img']}" class="img-thumbnail img-responsive" alt="{$d['account']}">
                    {/if}
        ...
        <div class="panel-body list-group border-bottom m-t-n-lg">
            ...
            <a href="#" id="scholarship" class="list-group-item"><span class="fa fa-graduation-cap"></span> {$_L['Scholarship Details']}</a>
