    ...
    <div class="ibox-content">
        ...
        <form class="form-horizontal" method="post" action="{$_url}">
            ...
            <div class="form-group" style="float: right; margin-right:70%">
                <input type="checkbox" class="create_mode_type" id="show_scholarship_invoice" name="show_scholarship_invoice">Show Scholarship Invoice
            </div>
            <br><br>
...
<script type="text/javascript">
  ...
  function filter_search(){
        ...
        $.post(_url + 'invoices/previous-list/filter', {
