            ...
            <div class="ibox-content" id="ibox_form">
                ...
                <form class="form-horizontal" method="post" id="pg-conf" role="form">
                    ...
                    <div class="form-group">
                        <label for="name" class="col-sm-3 control-label">{$_L['Name']} <span class="mandatory">*</span></label>
                        <div class="col-sm-9">
                    ...
                    <div class="form-group">
                        <label for="value" class="col-sm-3 control-label">{$label['value']} <span class="mandatory">*</span></label>
                        <div class="col-sm-9">
                            {$input['value']}
