            ...
            <div class="ibox-content">
                ...
                <form role="form" name="accadd" method="post" action="{$_url}settings/app-post">
                    <div class="form-group">
                        <label for="company">{'School Name'} <span class="mandatory">*</span></label>
                    ...
                    <div class="form-group">
                        <label for="theme">{$_L['Theme']} <span class="mandatory">*</span></label>
                    ...
                    <div class="form-group">
                        <label for="nstyle">{$_L['Style']} <span class="mandatory">*</span></label>
                    ...
                    <div class="form-group">
                        <label for="default_landing_page">{$_L['Default Landing Page']} <span class="mandatory">*</span></label>
                    ...
                    <div class="form-group">
                        <label for="opt_dashboard">{$_L['Dashboard']} <span class="mandatory">*</span></label>
                    ...
                    <div class="form-group">
                        <label for="caddress">{$_L['Pay To Address']} <span class="mandatory">*</span></label>
                    ...
                    <div class="form-group">
                        ...
                        <label for="invoice_terms">{$_L['Default Invoice Terms']} <span class="mandatory">*</span></label>
                    ...
                    <div class="form-group">
                        <label for="iai">{$_L['Invoice Starting']} #<span class="mandatory">*</span></label>
                    ...
                    <div class="form-group">
                        <label for="pdf_font">{$_L['PDF Font']} <span class="mandatory">*</span></label>
                    ...
                    <div class="form-group">
                        <label for="i_driver">{$_L['Invoice Creation Method']} <span class="mandatory">*</span></label>
