    ...
    <div class="col-lg-12 col-md-12 col-sm-12">
        <div class="ibox float-e-margins">
            ...
            <div class="ibox-content">
                ...
                <div id="result">
                    <h4>{'Total Payment'}: {$_c['currency_code']} {number_format($cr,2,$_c['dec_point'],$_c['thousands_sep'])}</h4>
                    <h4>{'Total Invoice'}: {$_c['currency_code']} {number_format($dr,2,$_c['dec_point'],$_c['thousands_sep'])}</h4>

                    <hr>
                    <h4>{$_L['All Transactions at Date']}: <span id="tdate">{date( $_c['df'], strtotime($mdate))}</span> </h4>
                    <hr>
                    <table class="table table-striped table-bordered table-responsive" id="dt_table">
                        <thead>
                            <tr>
                                <th>{$_L['Account']}</th>
                                <th>{$_L['Type']}</th>
                        ...
                        {foreach $d as $ds}
                            <tr>
                                ...
                                <td class="hidden-xs hidden-sm hidden-md">{$ds['fname']} {$ds['lname']}</td>
