...
{*<input type="hidden" name="desc[]" value="Fees">        *}
<div class="col-md-8">
                ...
                <div class="panel-body">
                    ...
                    <div>
                        <div class="form-group col-md-12">
                            <div class="col-sm-6"><label for="account" class="col-sm-3 control-label">{$_L['Account']}<span class="mandatory">*</span></label></div>
                            <div class="col-sm-6">
                                <select id="account" name="account" class="form-control">
                                    <option value="">{$_L['Choose an Account']}</option>
                                    {foreach $accounts as $ds}
                        ...
                        <div class="panel panel-default">
                            <div class="panel-heading">Invoice Type</div>
                            <div class="panel-body">
                                <div class="form-group col-md-6">
                                    <input type='radio' id='create_mode' class="create_mode" name="create_mode"  value='single' checked='true'> Single Invoice
                                </div>
                                <div class="form-group col-md-6">
                                    <input type='radio' id='create_mode' class="create_mode" name="create_mode" value='multiple' > Multiple Invoice
                                </div>
                            </div>
                        </div>
                        {*<div class="panel panel-default">
                            <div class="panel-heading">Recurring Frequency</div>
                            <div class="panel-body">
                                <div class="form-group col-md-6">
                                    <input type='radio' id='create_invoice_type' class="create_mode_type" name="create_invoice_type"  value='onetime' checked='true'> One Time Invoice
                                </div>
                                <div class="form-group col-md-6">
                                    <input type='radio' id='create_invoice_type' class="create_mode_type" name="create_invoice_type" value='recurring' > Recurring Invoice
                                </div>
                            </div>
                        </div>
                        
                        <div class="panel panel-default">
                            <div class="panel-heading">Add Dormitory & Transport Fee</div>
                            <div class="panel-body">
                                <div class="form-group col-md-6">
                                    <input type='checkbox' id='hostel_fee' class="create_mode_type" name="hostel_fee"  value='hostel' > Add Hostel Fee
                                </div>
                                <div class="form-group col-md-6">
                                    <input type='checkbox' id='transport_fee' class="create_mode_type" name="transport_fee" value='transport' > Add Transport Fee
                                </div>
                            </div>
                        </div>*}
                        
                        <div class="form-group col-md-6">
                            <label for="cid">{'Class'}<span id="gidStar" class="mandatory">*</span></label>
                        ...
                        <div class="form-group col-md-6">
                            <label for="cid">{'Section'}<span id="sidStar" class="mandatory">*</span></label>

                            <select id="section_id" name="section_id" class="form-control">
                                    <option value="">{'Select Class First'}</option>
                            </select>
                        </div>
                        <div class="form-group col-md-6 single-invoice-student" >
                            <label for="cid">{'Student'}<span id ="cidStar" class="mandatory">*</span></label>

                            <select id="cid" name="cid" class="form-control">
                                {*<option value="">{'Select Student'}...</option>
                                {foreach $c as $cs}
                                    <option value="{$cs['id']}"
                                            {if $p_cid eq ($cs['id'])}selected="selected" {/if}>{$cs['account']} {if $cs['lname'] neq ''}- {$cs['lname']}{/if}</option>
                                {/foreach}*}
                        ...
                        {*if $recurring*}
                        <div class="form-group col-md-6 single-invoice-student-repeat" style="display: none;">
                                ...
                                <select class="form-control" name="repeat" id="repeat">
                                    ...
                                    <option value="month1">{$_L['Month']}</option>
                        ...
                        <input type="hidden" id="discount_type" name="discount_type" value="f">
                        ...
                        {*<div class="form-group col-md-6">
                            <input type="checkbox" name="fine_for_due" id="fine_for_due" value="1">&nbsp;&nbsp;&nbsp;
                            <label for="idate">{'Fine For Due Invoice'}</label>
                        ...
                        {*<div class="form-group col-md-6">
                            <label for="add_discount"><a href="#" id="add_discount" class="btn btn-info btn-xs"
                                            ...
                                            class="fa fa-minus-circle"></i> {'Give Scholarship'}{*$_L['Set Discount']</a></label>
                            <br>
                ...
                <div class="panel-body">
                    ...
                    <div class="table-responsive m-t">
                        <table class="table invoice-table" id="invoice_items">
                            <thead>
                            <tr>
                                <th width="10%">{'SL No'}{*$_L['Item Code']*}</th>
                                <th width="50%">{'Fees'}{*$_L['Item Name']*}</th>
                                <!--<th width="10%">{*$_L['Qty']*}</th>-->
                                <th width="30%">{'Charges'}{*$_L['Price']*}</th>
...
{*                            <tr> <td></td> <td><textarea class="form-control item_name" name="desc[]" rows="3"></textarea> </td> <td><input type="text" class="form-control qty" value="" name="qty[]"></td> <td><input type="text" class="form-control item_price" name="amount[]" value=""></td> <td class="ltotal"><input type="text" class="form-control lvtotal" readonly="" value=""></td> <td> <select class="form-control taxed" name="taxed[]"> <option value="Yes">{$_L['Yes']}</option> <option value="No" selected="">{$_L['No']}</option></select></td></tr>*}
                    ...
                    <button type="button" class="btn btn-primary" id="item-add"><i
                                class="fa fa-search"></i>  {'Add Fee or Charge'} </button>
            ...
            <div class="panel panel-default">
                <div class="panel-body">
                    ...
                    <table class="table invoice-total">
                        ...
                        <tr>
                            <td><strong>{'Scholarship Discount'}{*$_L['Discount']*} <span id="is_pt"></span> :</strong></td>
