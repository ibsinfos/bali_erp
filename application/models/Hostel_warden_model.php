...
class Hostel_warden_model extends CI_Model {

    private $_table = "hostel_warden";
    ...
    public function getAll() {
     ...
     public function update($warden_id,$data) {
        $this->db->where('warden_id',$warden_id);
        $this->db->set($data);
        $this->db->update($this->_table);
        return true;
    }
    public function delete($data) {
        $this->db->where('warden_id',$data);
        $this->db->delete($this->_table);
        return true;
    }

    public function warden_count()
    {
        $school_id = '';
        if(($this->session->userdata('school_id'))) {
            $school_id = $this->session->userdata('school_id');
        ...
        $this->db->count_all_results($this->_table, '*', array('status' => "Active"), 'result_arr');
    }
    /**
     * 
     * @param type $id
