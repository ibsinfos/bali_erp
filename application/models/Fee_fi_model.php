...
class Fee_fi_model extends CI_Model {

    private $_table = "fees_fi";
    ...
    public function update($hostel_room_id,$dataArray){
        $this->db->where(array('room_id'=>$hostel_room_id));
    ...
    public function update_transport_charge($data2, $route_id){
