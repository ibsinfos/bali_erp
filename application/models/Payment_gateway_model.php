...
class Payment_gateway_model extends CI_Model {
    ...
    public function save_payment_options($dataArray) {
        $school_id = '';
        ...
        $this->db->insert('payment_gateway', $dataArray);
        generate_log($this->db->last_query());
        $payment_id = $this->db->insert_id();
        return $payment_id;
    }

    public function delete_payment_options($condition) {
        $this->db->where($condition);
        $this->db->update('payment_gateway', array('isActive' => '0'));
        return true;
    }

    public function update_payment_options($dataArray, $condition) {
        $this->db->where($condition);
        $this->db->update('payment_gateway', $dataArray);
        return true;
    }
