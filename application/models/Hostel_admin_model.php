...
class Hostel_admin_model extends CI_Model {
    ...
    public function update_profile($dataArray, $admin_id) {
        $this->db->where('hostel_admin_id', $admin_id);
        $this->db->update($this->_table, $dataArray);
        return true;
    }

    public function updatehosteladmin_password($curr_pwsd, $admin_id) {
        $this->db->where('hostel_admin_id', $admin_id);
        $this->db->update($this->_table, array('password' => $curr_pwsd));
        return true;
    }
