...
class Campus_updates_model extends CI_Model {

    private $_table = "campus_updates";

    function __construct() {
        parent::__construct();
    }

    public function add_updates($dataArray) {
        $school_id = '';
        ...
        $this->db->insert('campus_updates', $dataArray);
    ...
    public function edit_updates($dataArray, $condition) {
        ...
        $this->db->update('campus_updates', $dataArray);
        return true;
    }

    public function delete_updates($condition) {
        $this->db->where($condition);
        $this->db->update('campus_updates', array('isActive' => '0'));
        return true;
    }
