...
class Email_model extends CI_Model {
	...
	function account_opening_email($account_type = '' , $email = '',$password='')
	{
		...
		$email_msg		.=	"Login Here : <a href=\"".base_url()."/\">".base_url(). "</a><br />";
	...
	function do_email($msg=NULL, $sub=NULL, $to=NULL, $from=NULL)
	{
		...
		$msg	=	$msg."<br /><br /><br /><br /><br /><br /><br /><hr /><center><a href=\"http://sharadtechnologies.com/\">&copy; 2016 Sharad School Management System</a></center>";
        ...
        //SEND EMAIL TO PARENT FOR PROGRESS REPORT By Beant Kaur
        function email_sendToParent($msg=NULL, $sub=NULL, $to=NULL, $from=NULL)
	{
//		pre($msg);
//                die;
        $config = array();
