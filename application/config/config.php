...
if($_SERVER['HTTP_HOST']==SMS_IP_ADDR || $_SERVER['HTTP_HOST']=='localhost:8080' || $_SERVER['HTTP_HOST']=='localhost' || $_SERVER['HTTP_HOST']==CURRENT_IP_ADDR){
	$config['base_url'] = CURRENT_HTTP_PROTOCOL.$_SERVER['HTTP_HOST'].'/'.CURRENT_INSTANCE;
}else{
	$config['base_url'] = CURRENT_HTTP_PROTOCOL.$_SERVER['HTTP_HOST'];
}
