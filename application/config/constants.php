...
if($_SERVER['HTTP_HOST']==SMS_IP_ADDR || $_SERVER['HTTP_HOST']=='localhost' || $_SERVER['HTTP_HOST']=='localhost:8080' || $_SERVER['HTTP_HOST']==CURRENT_IP_ADDR){
...
include $share_constant_full_path; */
require __DIR__.'/shared_constant.php';
/*
|--------------------------------------------------------------------------
...
if($_SERVER['HTTP_HOST']==SMS_IP_ADDR || $_SERVER['HTTP_HOST']=='localhost:8080' || $_SERVER['HTTP_HOST']=='localhost' || $_SERVER['HTTP_HOST']==CURRENT_IP_ADDR){
