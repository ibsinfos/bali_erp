    ...
    <div class="col-md-12 p-0">
        <div class="col-lg-4 col-sm-4 col-xs-12">
            <div class="white-box" data-step="5" data-intro="<?php echo get_phrase('Transfer Certificate Genereate');?>" data-position='right'>
                ...
                <ul class="list-inline text-center">
                    <a href="<?php echo base_url(); ?>index.php?student/print_transfer_certificate/<?php echo $student_id; ?>">
        ...
        <div class="col-lg-4 col-sm-4 col-xs-12">
            <div class="white-box" data-step="6" data-intro="<?php echo get_phrase('Merit Certificate Genereate');?>" data-position='right'>
                ...
                <ul class="list-inline text-center">
                    <a href="<?php echo base_url(); ?>index.php?student/print_merit_certificate/<?php echo $student_id; ?>">
                ...
                foreach ($subfiles as $row):
                    ?>
                        <tr>                                    
                            ...
                            <td>
                                <!--Download-->
                                <a href="<?php echo base_url(); ?>index.php?student/download_document/<?php echo $row->Key; ?>" ><i class="fa fa-downlaod"></i><button type="button" class="btn btn-default btn-outline btn-circle btn-lg m-r-5 tooltip-danger" data-toggle="tooltip" data-placement="top" data-original-title="Download"><i class="fa fa-download"></i></button></a>
