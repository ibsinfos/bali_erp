...
<div class="row" >
    <div class="col-md-12 text-right form-group">
        <a href="<?php echo base_url(); ?>index.php?blogs/create_blog" class="btn btn-primary btn-circle btn-lg pull-right tooltip-danger" data-toggle="tooltip" data-placement="left" title="" data-original-title="Create a new blog">
            <i class="fa fa-plus" data-step="5" data-intro="<?php echo get_phrase('Create a new  blog');?>" data-position='top'></i>
        </a>
    </div>
</div>
<div class="row">
    <div class="col-md-12">
        <div class="white-box" data-step="6" data-intro="<?php echo get_phrase('Lists your own blogs and its status.');?>" data-position='top'>
