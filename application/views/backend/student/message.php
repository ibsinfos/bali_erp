                        ...
                        <ul class="chatonline style-none list-unstyled">
                            ...
                            foreach ($current_user_threads as $row):
                                ...
                                if ($user_to_show_type == "teacher") {
                                    ...
                                    ?>
                                    <li>
<a href="<?php echo base_url(); ?>index.php?student/message/message_read/<?php echo $row['message_thread_code']; ?>" style="padding:12px;" class="<?php if(($SelectedUserType == 'teacher') && ($SelectedUserId == $row['teacher_id'])){ echo 'SelectedUser'; }?>">
                                            <?php
                        ...
                        <ul class="chatonline style-none list-unstyled">
                            ...
                            foreach ($current_user_threads as $row):
                                ...
                                if ($user_to_show_type == "school_admin") {
                                    ...
                                    ?>
                                    <li>
<a href="<?php echo base_url(); ?>index.php?student/message/message_read/<?php echo $row['message_thread_code']; ?>" style="padding:12px;" class="<?php if(($SelectedUserType == 'school_admin') && ($SelectedUserId == $row['school_admin_id'])){ echo 'SelectedUser'; }?>" >
<?php
                                           if (array_key_exists('name',$row)) {
        ...
        if((segment=='message_read') && (current_thread!='')){
            ...
            function ajaxCallUnreadMessage() {
                if((segment=='message_read') && (current_thread!='')){
                    $.ajax({
                        type: "POST",
                        url: "<?php echo base_url().'index.php?student/message/message_read/'.$current_thread.'/ajax' ?>",
