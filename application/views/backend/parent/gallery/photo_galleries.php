...
<div class="row m-0">
    <div class="col-md-12 white-box">
        <div class="sttabs tabs-style-flip">
            <nav>
                <ul>
                    <li class="active" data-step="5" data-intro="<?php echo get_phrase('From here you can manage photo galleries');?>" data-position='top'>
                        ...
                        <tbody>
                            ...
                            foreach ($records as $rec): ?>
                                <tr>
                                    ...
                                    <td>
                                        <a href="<?php echo base_url('index.php?'.$this->session->userdata('login_type').'s/photo_gallery_images/'.$rec->id)?>">
