...
<div class="navbar-default sidebar custom-sidebar-width" role="navigation">
    <div class="sidebar-nav slimscrollsidebar">
        ...
        <ul class=" nav p-r-0" id="side-menu">
            ...
            $i = 0;
            $children_of_parent = get_data_generic_fun('student', '*', array('parent_id' => $this->session->userdata('parent_id')), 'result_arr');
            foreach ($arrModule as $key => $value) {
                            ...
                            switch (strtolower($key)) {
                                ...
                                case 'transport':
                                    if ($i == 0) {
                                        ...
                                        <?php
                                        if (count($children_of_parent)) {
                                            echo '<ul class="nav p-r-0 list-inline">';
                                            foreach ($children_of_parent as $row) {
                                                ?>

                                                <li class="p-0 menu-item-tile">
                                                    <a href="<?php echo base_url(); ?>index.php?<?php echo $link; ?>/<?php echo $row['student_id']; ?>" class='waves-effect active menu-items text-center'><i class="icon-size fa fa-user"></i><span class='menu-text'><?php echo $row['name']; ?></span></a>
                                                </li>
                                            <?php }if (isset($arrTransport['track_buses'])) { ?>

                                                <li class="p-0 menu-item-tile">
                                                    <a href="<?php echo base_url(); ?>index.php?<?php echo 'parents/livetrack'; ?>" class='waves-effect active menu-items text-center'><i class="icon-size fa fa-bus"></i><span class='menu-text'><?php echo get_phrase('track_buses'); ?></span></a></li><?php
                                            }
                                            echo "</ul>";
                                        }
                                    }
                                ...
                                default :
                                    ...
                                    <ul class="nav p-r-0 list-inline">  
                                        <?php foreach ($children_of_parent as $row): ?>
                                            <li class="p-0 menu-item-tile">
                ...
                <ul class="nav p-r-0 list-inline">
                    <li class="p-0 menu-item-tile">
                        <a href="<?php echo base_url(); ?>index.php?<?php echo 'parents/online_polls'; ?>" class='waves-effect active menu-items text-center'>
                            <i class="icon-size fa fa-bar-chart"></i>
                            <span class='menu-text'><?php echo get_phrase('online_polls'); ?></span>
                        </a>
                    </li>
                    <li class="p-0 menu-item-tile">
                        <a href="<?php echo base_url(); ?>index.php?<?php echo 'parents/online_polls_result'; ?>" class='waves-effect active menu-items text-center'>
                            <i class="icon-size fa fa-bar-chart"></i>
                            <span class='menu-text'><?php echo get_phrase('online_polls_result'); ?></span>
                        </a>
                    </li>
                </ul>
            </ul>
