    ...
    if ($certificate_detail->is_approve == '1') {
        ...
        <div class="row">    
            <div class="col-md-12 m-b-20 text-right">    
                <input type="button" value="Print" id="print_button" onclick="PrintElem('#print');" class="fcbtn btn btn-danger btn-outline btn-1d" data-step="5" data-intro="Please click on print button, then print merit certificate." data-position='right'> 
            </div>
        </div>
