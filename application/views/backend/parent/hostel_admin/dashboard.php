...
<div class="dashboard display-animation container" style="margin: 0 auto;">
    <a class="tile tile-lg tile-pink ripple-effect tile-big" href="<?php echo base_url(); ?>index.php?<?php echo $account_type; ?>/student_list">
        <span class="content-wrapper">
            <span class="tile-content">
                <span class="tile-img"><i class="fa fa-user"></i></span>
                <span class="tile-holder tile-holder-sm">
                    <span class="title"><?php echo get_phrase('student_list'); ?></span>
                </span>
            </span>      
        </span>
    </a>
