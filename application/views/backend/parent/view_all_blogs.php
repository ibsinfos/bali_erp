<div class="row bg-title">
    ...
    <div class="col-lg-9 col-sm-8 col-md-8 col-xs-12">
        ...
        <ol class="breadcrumb">
            ...
            <li class="active">
                <?php echo get_phrase('view_published_blogs'); ?>
            </li>
        </ol>
    </div>
    <!-- /.breadcrumb -->
...
<div class="row">
    <div class="col-md-10"  data-step="5" data-intro="<?php echo get_phrase('List the available category');?>" data-position='top'>
        <div class="form-group col-md-6 p-0">
            ...
            <select class="selectpicker" data-live-search="true" data-style="form-control" name="search_id" onchange="get_blogs_by_category(this.value);" id="category_id">
                <option value="0">
                    <?php echo get_phrase('select_category');?>
                </option>
                <option value="0">
...
<script>
    ...
    if(author_id > 0) { 
        url = "<?php echo base_url() . 'index.php?ajax_controller/view_all_blog_student_login/'.$author_id; ?>";
    } else {
