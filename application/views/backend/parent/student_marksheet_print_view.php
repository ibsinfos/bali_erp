...
<div id="print">
	...
	<center>
		...
		<?php echo $studentDataArr['student_name'];?><br>
    ...
    <tbody>
        <?php 
            //$total_marks = 0;
            //$total_grade_point = 0;
            foreach ($subjects as $row3): //pre($row3);die;
        ?>
            <tr>
                ...
                <td style="text-align: center;">
                    ...
                    echo $highest_mark;*/
                    echo $row3['heighest_mark'];
                    ?>
                </td>
                <td style="text-align: center;">
                    <?php
                       
                        echo $row3['grade_name'];
                    ?>
                </td>
                <td style="text-align: center;"><?php echo $row3['comment'];?></td>
            </tr>
        <?php endforeach;?>
    </tbody>
   </table>
