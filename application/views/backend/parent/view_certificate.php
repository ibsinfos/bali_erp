            ...
            if (!empty($certificate_list)):
                ...
                foreach ($certificate_list as $row):
                    ...
                    <tr>
                        ...
                        <td><a href="<?php echo base_url(); ?>index.php?certificate/<?php echo strtolower($row['template_type']); ?>/download/<?php echo $row['student_id']; ?>/<?php echo $row['certificate_id']; ?>"><button type="button" class="btn btn-default btn-outline btn-circle btn-lg m-r-5 tooltip-danger" data-toggle="tooltip" data-placement="top" data-original-title="View Certificate"><i class="fa fa-eye"></i></button></a>                                                              </td>
                    </tr>
                <?php endforeach; ?>
            <?php endif; ?>
        </tbody>
