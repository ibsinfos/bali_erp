...
<div class="row">
    <div class="col-md-12 text-right m-b-20"> 
        <span class="badge badge-stu-name badge-danger"><?php echo $student->name; ?></span>
    </div>
...
<?php if (!empty($certificate_detail)) {
    if ($certificate_detail->is_approve == '1') {
        ...
        <div class="m-b-20 col-md-12 text-right no-padding">
                ...
                <button value="Print" id="print_button" onclick="PrintElem('#print');" class="fcbtn btn btn-danger btn-outline btn-1d" data-step="5" data-intro="<?php echo get_phrase('Click on print button, then print the certificate.');?>" data-position='right'> Print </button>
            ...
            <div class="col-md-12 white-box">
                ...
                <form method="post">
                    <div class="form-group col-md-6">
                        ...
                        <div>
                            <input type="text" name="certificate_no" id="certificate_no11" placeholder="" value=" <?php $tc_no = $tc_number->tc_id;
        $tc_no = $tc_no + 1;
        echo "DA/TC/" . $tc_no; ?>" class="form-control" required readonly="">
                            <input type="hidden" id="certificate_no" name="certificate_no" value="<?php echo $tc_no; ?>" >
                            <div id="certificate_no11_val" class="print_text"><?php $tc_no = $tc_number->tc_id;
        $tc_no = $tc_no + 1;
        echo "DA/TC/" . $tc_no; ?></div>
        ...
        <?php endforeach; ?>
                    ...
                    <div class="form-group col-md-6">
                        ...
                        <div>   
                            <input type="text" name="class" id="class" value="<?php if ($class_admitted != '') {
            echo $class_admitted->name;
        } else {
            echo "";
        } ?>" placeholder="" class="form-control" readonly="">
                            <div id="class_val" class="print_text"><?php if ($class_admitted != '') {
            echo $class_admitted->name;
        } else {
            echo "";
        } ?></div>
