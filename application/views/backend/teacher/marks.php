    	...
    	<!------CONTROL TABS END------>
            ...
            <div class="tab-pane  <?php if(!isset($edit_data) && !isset($personal_profile) && !isset($academic_result) )echo 'active';?>" id="list">
                ...
                <table border="0" cellspacing="0" cellpadding="0" class="table table-bordered">
                	...
                	<tr>
                        <td>
                        	<select name="exam_id" data-style="form-control" data-live-search="true" class="selectpicker" style="float:left;">
                        ...
                        <td>
                        	<select name="class_id" data-style="form-control" data-live-search="true" class="selectpicker" onchange="show_subjects(this.value)"  style="float:left;">
                        ...
                        <td>
							...
							<?php 
                                ...
                                <select name="<?php if($class_id == $row['class_id'])echo 'subject_id';else echo 'temp';?>" 
                                      id="subject_id_<?php echo $row['class_id'];?>" 
                                          style="display:<?php if($class_id == $row['class_id'])echo 'block';else echo 'none';?>;" data-style="form-control" data-live-search="true" class="selectpicker" style="float:left;">
                            ...
                            <select name="temp" id="subject_id_0" 
                              style="display:<?php if(isset($subject_id) && $subject_id >0)echo 'none';else echo 'block';?>;" data-style="form-control" data-live-search="true" class="selectpicker" style="float:left;">
