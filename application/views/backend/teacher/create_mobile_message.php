...
<?php echo form_open(base_url() . 'index.php?teacher/send_notices/send', array('class' => 'form', 'id' => 'SendMessage')); ?>
...
<script type="text/javascript">
    ...
    SendMessageFrm.submit(function (e) {
        ...
        var ParentFlag = TotalParent = StudentFlag = TotalStudent = 0;
debugger;
