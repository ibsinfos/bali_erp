...
<div class="form-group col-sm-3" style="padding: 0">
    ...
    <select  data-style="form-control" data-live-search="true" class="selectpicker" onchange="window.location = this.options[this.selectedIndex].value">
        ...
        <option <?php if ($class_id == $row['class_id']) { echo 'selected'; } ?> value="<?php echo base_url(); ?>index.php?teacher/class_routine_view/<?php echo $row['class_id']; ?>">
...
<div class="row">
    ...
    <div class="col-md-12">
        ...
        <div class="panel panel-default" data-collapsed="0">
            <div class="panel-heading panel-head-space">
                <div class="panel-title panel-title-sec-name">
                    ...
                    <a href="<?php echo base_url();?>index.php?school_admin/class_routine_print_view/<?php echo $class_id;?>/<?php echo $row['section_id'];?>" 
