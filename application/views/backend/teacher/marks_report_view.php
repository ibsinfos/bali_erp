...
<?php echo form_open(base_url() . 'index.php?teacher/marks_report_selector');?>
...
<?php if(count($sections)){ foreach($sections as $row): ?>
				...
				<div class="col-md-3 col-sm-6 col-xs-12">
					<div class="form-group" data-step="8" data-intro="<?php echo get_phrase('Please Select Your Subject');?>" data-position='bottom'>				    
						...
						<select name="subject_id" id="subject_id" data-style="form-control" data-live-search="true" class="selectpicker">
...
<script type='text/javascript'> 
    ...
    $(document).ready(function() {
        table = $('#table').DataTable({ 
            ...
            "ajax": {
                "url": "<?php echo base_url(); ?>index.php?ajax_controller/marks_report_list_teacher_login/",
                "type": "POST",
