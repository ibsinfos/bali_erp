			...
			<div class="panel-body">
                ...
                <?php echo form_open(base_url() . 'index.php?teacher/student/do_update/'.$row['student_id'].'/'.$row['class_id'] , array('class' => 'form-horizontal form-groups-bordered validate', 'enctype' => 'multipart/form-data'));?>
					...
					<div class="form-group">
						...
						<div class="col-sm-5">
							<select name="section_id" data-style="form-control" data-live-search="true" class="selectpicker">
					...
					<div class="form-group">
						...
						<div class="col-sm-5">
							<select name="parent_id" data-style="form-control" data-live-search="true" class="selectpicker" data-validate="required" data-message-required="<?php echo get_phrase('value_required');?>">
