...
<div class="row">
    <div class="col-md-12 m-b-20">
         <a href="<?php echo base_url(); ?>index.php?discussion_forum/create_thread/" class="btn btn-primary btn-circle btn-lg pull-right tooltip-danger" data-toggle="tooltip" data-placement="left" title="" data-original-title="Add New Thread" data-step="5" data-intro="<?php echo get_phrase('From here you can add a new discussion post.');?>" data-position="left"><i class="fa fa-plus"></i>
        </a>
    </div>
</div>    
