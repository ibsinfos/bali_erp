...
<div class="row">
    <div class="col-md-12" data-step="5" data-intro="<?php echo get_phrase('You can enter the title, categeory and description and create a thread.');?>" data-position="top">   
            <?php     
            ...
            <div class="form-group col-md-6">
                ...
                <select name="category" id="category" data-style="form-control" data-live-search="true" class="selectpicker" required>
