...
<ul class="menu">
    ...
    <li class="<?php if ($page_name == 'books_detail' || $page_name == 'issued_books') echo 'opened active'; ?> ">
        <a href="#">
            <span><i class="entypo-book-open"></i> <?php echo get_phrase('library'); ?></span>
        </a>
        <ul class="sub-menu-list">
            <li class="<?php if ($page_name == 'books_detail') echo 'active'; ?>">
                <a href="<?php echo base_url(); ?>index.php?<?php echo $account_type; ?>/books_detail">
                    <span><i class="entypo-book"></i><?php echo get_phrase('books'); ?></span>
                </a>
            </li>
            <li class="<?php if ($page_name == 'issued_books') echo 'active'; ?>">
                <a href="<?php echo base_url(); ?>index.php?<?php echo $account_type; ?>/issued_books">
                    <span><i class="entypo-doc-text"></i><?php echo get_phrase('issue_books'); ?></span>
                </a>
            </li>
        </ul>
    </li>
    ...
    <li class="<?php if ($page_name == 'discusssion_forum') echo 'active'; ?> ">
        <a href="#"><span><i class="entypo-network"></i> <?php echo get_phrase('forums_&_blogs'); ?></span></a>
            <ul class="sub-menu-list">   
                <li class="<?php if ($page_name == 'discusssion_forum') echo 'active'; ?> ">
                    <a href="#"
                    ...
                    <ul class="sub-menu-list">
                        <li class="<?php if ($page_name == 'view_blogs' )echo 'active'; ?> ">
                            <a href="<?php echo base_url(); ?>index.php?blogs/view_all_blogs">
                                <span><i class="entypo-archive"></i> <?php echo get_phrase('view_published_blogs'); ?></span>
                            </a>
                        </li>
                       <li class="<?php if ($page_name == 'view_my_blogs' )echo 'active'; ?> ">
                            <a href="<?php echo base_url(); ?>index.php?blogs/view_my_blogs">
                                <span><i class="entypo-archive"></i> <?php echo get_phrase('view_my_blogs'); ?></span>
                            </a>
                        </li>
                    </ul>
                </li>
