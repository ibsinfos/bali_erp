...
<div class="col-md-12 white-box">
    ...
    <div class="row">
        <div class="col-xs-12 col-md-6 form-group">
            <label for="field-1"><?php echo get_phrase('min_length'); ?><span class="error mandatory"> *</span></label>
           <div class="input-group">
                <div class="input-group-addon"><i class="fa fa-long-arrow-down"></i></div>
                <input type="text" class="form-control" data-validate="required" required="required" id="min_length" placeholder="Min Length" name="min_length" data-message-required="<?php echo get_phrase('please_enter_required_value'); ?>"> 
            </div>
            <span></span>
        </div>

        <div class="col-xs-12 col-md-6 form-group">
            <label for="field-1"><?php echo get_phrase('max_length'); ?><span class="error mandatory"> *</span></label>
           <div class="input-group">
                <div class="input-group-addon"><i class="fa fa-long-arrow-up"></i></div>
                <input type="text" class="form-control" data-validate="required" required="required" id="max_length" placeholder="Max Length" name="max_length" data-message-required="<?php echo get_phrase('please_enter_required_value'); ?>"> 
            </div>
            <span></span>
        </div>
    </div>
     <div class="row">
        ...
        <div class="col-xs-12 col-md-6 form-group">
           ...
           <div class="input-group">
                <div class="input-group-addon"><i class="fa fa-tag"></i></div>
                <input type="text" class="form-control" data-validate="required" id="field_values" placeholder="Field Values" name="field_values" data-message-required="<?php echo get_phrase('please_enter_required_value'); ?>" onchange="check_value(this.value);"> 
            </div>
            <span></span>
        </div>
    </div>
...
<div class="row">
     <div class="col-xs-12 col-md-6 form-group">
           ...
           <div class="input-group">
                ...
                <input type="text" class="form-control" data-validate="required" required="required" id="field_table" placeholder="Field Table" name="field_table" data-message-required="<?php echo get_phrase('please_enter_required_value'); ?>"> 
            </div>
            <span></span>
        </div>
        <div class="col-xs-12 col-md-6 form-group">
...
<?php endforeach; ?>              
    ...
    <div class="row">
        <div class="col-xs-12 col-md-6 form-group">
           ...
           <div class="input-group">
                <div class="input-group-addon"><i class="fa fa-tag"></i></div>
                <input type="text" class="form-control" data-validate="required" id="field_select" name="field_select" placeholder="Field Select" data-message-required="<?php echo get_phrase('please_enter_required_value'); ?>"> 
            </div>
            <span></span>
        </div>
        <div class="col-xs-12 col-md-6 form-group">
            ...
            <div class="input-group">
                ...
                <input type="text" class="form-control" data-validate="required" id="field_where" placeholder="Field Where" name="field_where" data-message-required="<?php echo get_phrase('please_enter_required_value'); ?>"> 
            </div>
            <span></span>
        </div>
    </div>
...
<script type="text/javascript">
    function check_value(value){
        if(value == 'query'){
     document.getElementById("field_table").disabled = true;
     document.getElementById("field_select").disabled = true;
     document.getElementById("field_where").disabled = true;
 }
    }
</script>