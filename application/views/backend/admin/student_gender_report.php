...
<?php echo form_open(base_url() . 'index.php?admin/admin_report/'); ?>
                   ...
                   break;
                    ...
                    case 'date':
                        ...
                        echo "<input type='text' class='form-control' name='$db_field' "
                                . "id='$db_field' placeholder=''  data-start-view='2'>"
                            ."</div>";
                        echo "</div>";
                    break;        
                    case 'drop' :
                        ...
                        <label for='control-label'>".
                            ...
                            echo "</label>";        
                        echo "<select class='selectpicker' data-live-search='true' $ajax_event data-style='form-control' data-container='body'  name='$db_field' id='$db_field' "
                                .  ">".
