 <div class="row">
	<div class="col-md-12">    
        <!--<div class="">-->
        <?php echo form_open(base_url() . 'index.php?admin/manage_vehicle_details/service/'.$param2 ,  array('class' => ' form-material form-groups-bordered validate', 'enctype' => 'multipart/form-data')); ?>
