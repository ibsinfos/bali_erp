...
<table id="example23" class="display nowrap" cellspacing="0" width="100%">
    <thead>
        ...
        <?php if($schools_id == ""){?>
            ...
            <th><div><?php echo get_phrase('total_number_of bus'); ?></div></th> 
        <?php } if($schools_id != ""){?>
            <th><div><?php echo get_phrase('route_name'); ?></div></th> 
             <th><div><?php echo get_phrase('bus_name'); ?></div></th>
        <?php }?>
            ...
            foreach ($res as $row){   ?>
                <tr>
                    ...
                    <?php if($schools_id == ""){?>
                        ...
                        <td><div><?php echo $row['bus_total']; 
                            $all_total+=$row['bus_total'];
                        ?></div></td> 
                    <?php } if($schools_id != ""){?>
                        <td><div><?php echo $row['route_name']; 
                            $all_total++;
                        ?></div></td> 
