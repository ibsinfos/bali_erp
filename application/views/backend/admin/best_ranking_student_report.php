<div class="row bg-title">
    ...
    <div class="col-lg-9 col-sm-8 col-md-8 col-xs-12">
        ...
        <ol class="breadcrumb">
            <li><a href="<?php echo base_url(); ?>index.php?admin/dashboard"><?php echo get_phrase($page_title); ?></a></li>
...
<div class="col-sm-4 form-group" data-step="6" data-intro="Select a exam you want to see topper report" data-position='top'>
    ...
    <select name="exam_id" data-style="form-control" class="selectpicker" id="exam_holder" required  onchange="select_ranking(this.value)">
       <?php if(!empty($exams)) {?>
...
<!--                            <th><div><?php echo get_phrase("Male"); ?></div></th>                            
                    ...
                    $n = 1;
                    if(count($rs)>0){
                    foreach ($rs as $row){  if($n > 3)break; ?>
                        <tr>
                            <td><?php echo $n++;?></td>
