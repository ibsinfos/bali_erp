<div class="row bg-title">
    <div class="col-lg-3 col-md-4 col-sm-4 col-xs-12">
        <h4 class="page-title"><?php echo get_phrase('view_student_leave_report'); ?> </h4></div>
...
<div class="col-md-12 white-box">
    <?php echo form_open(base_url() . 'index.php?super_admin/student_leave_report_selector/'); ?>
...
<!--                    <td><button onclick='send_notification("<?php echo $row['student_id'];?>","<?php echo round($percentage, 2);?>")' class="btn-red"><?php echo get_phrase("send"); ?></button></td>-->
    ...
    <div class="text-right">
        <a href="<?php echo base_url(); ?>index.php?admin/student_leave_report_print_view/<?php echo $class_id; ?>/<?php echo $section_id; ?>/<?php echo $month; ?>" 
           class="fcbtn btn btn-danger btn-outline btn-1d" target="_blank" ><?php echo get_phrase('print_leave_sheet'); ?>
         </a>
    </div>
</div>             
...
/*for table view in mobile*/
    ...
    function send_notification(student_id,percentage){
        $.ajax({
        url: '<?php echo base_url(); ?>index.php?aschool_admin/send_sms_for_low_attendance/' + student_id +'/'+percentage,
        success: function (response) {
            //alert(response);
        }     
        });
