<?php $edit_data = $this->db->get_where('bus_administrator' , array('bus_administrator_id' => $param2))->row(); ?>

<div class="tab-pane box active" id="edit" style="padding: 5px">
    <div class="box-content">
        <?php echo form_open(base_url() . 'index.php?school_admin/bus_admin/edit/'.$edit_data->bus_administrator_id , array('class' => 'form-horizontal form-groups-bordered validate','target'=>'_top'));?>
