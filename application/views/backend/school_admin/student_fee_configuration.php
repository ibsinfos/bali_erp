...
<?php echo form_open(base_url() . 'index.php?school_admin/student_fee_configuration/add_student_det'); ?>
    ...
    <div class="col-md-12 white-box" data-step="6" data-intro="<?php echo get_phrase('From_here_by_filling_information_you_can_manage_the_promotion._After_filling_the_mandatory_fields_click_on_manage_promotion_button._Then_you_will_get_a_list_of_students.');?>" data-position='top'>
