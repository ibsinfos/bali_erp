                ...
                <div class="sttabs tabs-style-flip"> 
                    ...
                    <div class="content-wrap">
                        <section id="list">
                            ...
                            <?php echo form_open(base_url() . 'index.php?school_admin/cwa_settings/connect_exams', array('id'=>'connect_exams', 'class' => 'form-horizontal form-groups-bordered validate', 'target' => '_top')); ?>
                            <table class="table table-hover manage-u-table" id="example_cce">
                                ...
                                <tbody><?php //$count = 1; //if(count($cwa_exams)){foreach ($cwa_exams as $row): 
                                    $exam_id=array(); 
                                    if(count($connected_cwa_exams)){ 
                                        foreach ($connected_cwa_exams as $row) { 
                                            $exam_id[]=$row['exam_id']; 
                                        }
                                    } 
                                    if(count($cwa_exams)){
                                        $count = 1; 
                                        foreach ($cwa_exams as $row): 
                            ...
                            <div class="text-right col-xs-12 p-t-20">
                                <button type="submit" onclick="handleClick();" class="fcbtn btn btn-danger btn-outline btn-1d" id="connect_exam_submit">
                        ...
                        <section id="list_connect">
                            <table class="table table-hover manage-u-table" id="example_cce">
                                ...
                                <?php $count = 1; if(count($connected_cwa_exams)){foreach ($connected_cwa_exams as $row): ?>
                                    <tr>
                                        <td><?php echo $count++; ?></td>
                                        <td><?php echo $row['name']; ?></td>
                                        ...
                                        <td>             
                                            <a onclick="confirm_modal('<?php echo base_url(); ?>index.php?school_admin/cwa_settings/delete/<?php echo $row['exam_id']; ?>');">
