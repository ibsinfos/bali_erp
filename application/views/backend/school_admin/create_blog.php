...
<div class="row m-0">
    <div class="col-md-12 white-box">
        ...
        <?php
        echo form_open(base_url() . 'index.php?blogs/create_blog', array('class' => 'top-for-tabs'));
        ...
        <div class="row">
            <div class="form-group col-md-6">
                ...
                <select name='blog_category' class="selectpicker" data-style="form-control" data-live-search="true" id="blog_category">
                    <option value="">
            ...
            <div class="form-group col-md-6">
                ...
                <select name='subcategory' id='section__holder' class="selectpicker" data-style="form-control" data-live-search="true">
                    <option value=" "> <?php echo get_phrase('Select Subcategory'); ?>
                    </option>
                </select>
