	...
	<div class="col-md-12">
		<div class="panel panel-primary" data-collapsed="0">
			...
			<div class="panel-body">
                ...
                <?php echo form_open(base_url() . 'index.php?school_admin/expense/edit/' . $row['payment_id'] , array('class' => 'form-horizontal form-groups-bordered validate', 'enctype' => 'multipart/form-data'));?>
					...
					<div class="form-group">
                        ...
                        <div class="col-sm-6">
                            <select name="expense_category_id" class="selectpicker" data-style="form-control" data-live-search="true" required>
