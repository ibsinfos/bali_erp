<?php foreach ($edit_data as $data): ?>
    <div class="row">
        <div class="col-md-12">
            <div><a href="javascript: void(0);" onclick="showAjaxModal('<?php echo base_url(); ?>index.php?modal/popup/modal_add_subjects/icse');">
            ...
            <div class="panel-body">
                <?php echo form_open(base_url() . 'index.php?school_admin/icse_subjects/do_update/' . $data['id'], array('id' => 'subject_add', 'class' => 'form-horizontal form-groups-bordered validate', 'target' => '_top')); ?>
                <table class="table table-hover manage-u-table">
                    ...
                    <tbody>
                        <tr>
                            ...
                            <td>
                                <div class="checkbox-danger"><input type="checkbox" <?php if ($data['compulsory_subject'] == 1) { ?> checked="checked" <?php } ?>  id="asl<?php echo $data['subject_id']; ?>"  name="selected_compulsory_subject" value="1"></div>    
                            <td>                                            
                                <div class="checkbox-danger"><input type="checkbox" <?php if ($data['optional_subject'] == 1) { ?> checked="checked" <?php } ?> id="no<?php echo $data['subject_id']; ?>"  name="selected_optional_subject" value="1"></div>                                
                            </td>
                        </tr>
                    </tbody>
                </table>
