<div class="row" style="padding: 20px 0;">
    <div class="col-md-12"> &nbsp;
        <button type="button" class="btn btn-success" onclick="location.href='<?php echo base_url().'index.php?school_admin/view_marks_bulk_upload';?>';">Upload Mark Bulk Upload Excel File</button>
    </div>
</div>
