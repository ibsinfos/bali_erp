...
<style>
 .main_div{
    /*border-radius: 25px;*/
    background: url('assets/images/teacher_certificate3.jpg');
    width: 1300px;
    height: 980px; 
    }
    </style>
...
//                jQuery('#subject_holder').append(response);
    ...
    function Popup(data) {
        ...
        myWindow.document.write('<link rel="stylesheet" href="<?php echo base_url(); ?>assets/css/print_merit_certificate.css" type="text/css" /><style type="text/css"> .main_div{background-image: url("assets/images/teacher_certificate3.jpg"); width: 1300px; height: 880px; !important;}.print_text{font-size: 45px; !important;}</style>');
