    ...
    <div class="col-md-12">        
        <div class="white-box">
            ...
            <!----CREATION FORM STARTS---->
                        <section id="add">
                            <?php echo form_open(base_url() . 'index.php?school_admin/icse_subjects/'.$icse_class_id.'/add', array('id'=>'subject_add', 'class' => 'form-horizontal form-groups-bordered validate', 'target' => '_top')); ?>
                                <table class="table table-hover manage-u-table">
                                    ...
                                    <tbody>
<?php $icse_subject_id=array(); if(count($subjects)){ foreach ($subjects as $row){ $icse_subject_id[]=$row['subject_id'];}} if(count($class_subjects)){ foreach ($class_subjects as $row): if(!in_array($row['subject_id'], $icse_subject_id)){ ?>
                                        <tr>
                                            <td>
