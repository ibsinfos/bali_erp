...
<div class="row">
    <div class="col-md-12">
        <div class="form-group col-sm-12 p-0">
            <a href="<?php echo base_url(); ?>index.php?school_admin/bus_details/">
                <button type="button" data-step="5" data-intro="<?php echo get_phrase('From here you can add the details of bus.');?>" data-position='left' class="btn btn-primary btn-circle btn-lg pull-right tooltip-danger" data-toggle="tooltip" data-placement="left" title="" data-original-title="Add Vehicle Details"> 
