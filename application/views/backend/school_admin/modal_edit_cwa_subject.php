    ...
    <div class="row">
        <div class="col-md-12">
            ...
            <div class="panel-body">
                <?php echo form_open(base_url() . 'index.php?school_admin/cwa_subjects/do_update/' . $data['cwa_subject_id'], array('id' => 'subject_add', 'class' => 'form-horizontal form-groups-bordered validate', 'target' => '_top')); ?>
                <table class="table table-hover manage-u-table">
                    ...
                    <tbody>
                        <tr>
                            ...
                            <td><input type="text"  name="selected_credit_hours" id="weekly<?php echo $data['subject_id']; ?>" value="<?php echo $data['credit_hours']; ?>" class="form-control" onkeypress="return isNumber(event)" required/>
                            </td>
