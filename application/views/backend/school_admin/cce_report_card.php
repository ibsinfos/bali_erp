...
<?php echo form_open(base_url() . 'index.php?school_admin/cce_marksheet_selector/'); ?>
    ...
    function select_section(class_id) {
        $.ajax({
            ...
            success:function (response){//alert(response);
                jQuery('#section_holder').html(response).selectpicker('refresh').selectpicker('refresh');
            }
        });
        ...
        $.ajax({
            ...
            success:function (response){//alert(response);
                jQuery('#student_holder').html(response).selectpicker('refresh').selectpicker('refresh');
            }
        });
    }
</script>