...
<?php echo form_open(base_url() . 'index.php?school_admin/ibo_marks_selector'); ?>
...
<?php echo form_open(base_url() . 'index.php?school_admin/marks_update_ibo/' . $exam_id . '/' . $class_id . '/' . $section_id . '/' . $subject_id); ?>
...
<div class="form-group col-sm-12 p-0" data-step="10" data-intro="<?php echo get_phrase('Here you can view and edit exam marks.');?>" data-position='bottom'>
            ...
            <table id="table" class="table display" cellspacing="0" width="100%">
                <thead>
                    <tr>
                        ...
                        <?php foreach($subjAssessData as $key=>$assess) { ?>
                        <th><div><?php echo $assess['assessment_name']; ?></div></th>
                        <?php } ?>
	    ...
	    <div class="text-right col-xs-12 p-t-20">
                <button type="submit" class="fcbtn btn btn-danger btn-outline btn-1d" id="submit_button"><?php echo get_phrase('update_marks');?></button>
...
<script type="text/javascript">
    function get_class_subject(class_id) {
        ...
        $.ajax({
            url: '<?php echo base_url(); ?>index.php?school_admin/ibo_marks_get_subject/' + class_id,
...
//        var SearchName = $('#PublicSearch').val();
        ...
        table = $('#table').DataTable({ 
            ...
            "ajax": {
                "url": "<?php echo base_url().'index.php?ajax_controller/get_marks_manage_list_ibo/';?>",
                "type": "POST",
