<?php $user_id = $_SESSION["school_admin_id"];
...
<?php echo form_open(base_url() . 'index.php?school_admin/message/send_reply/' . $current_message_thread_code, array('enctype' => 'multipart/form-data')); ?>
                    <div class="col-sm-12">
