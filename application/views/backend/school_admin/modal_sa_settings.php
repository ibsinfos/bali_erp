...
<div class="row">
    <div class="col-md-12">
                <?php echo form_open(base_url() . 'index.php?school_admin/cce_settings/sa_max/' ); ?>
                    <div class="form-group">
                        <label for="maxmarks" class="control-label"><?php echo get_phrase("maximum_marks"); ?></label>
                        <input type="text" class="form-control" name="maxmarks" value="<?php echo $param2;?>" required></div>
                    </div>
