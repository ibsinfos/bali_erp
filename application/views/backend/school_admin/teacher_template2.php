...
<style>
 .main_div{
    /*border-radius: 25px;*/
    background: url('assets/images/teacher_certificate2.png');
    width: 1300px;
    height: 920px; 
    }
    </style>
...
<div class="row m-0">
    ...
    <div class="col-md-12 white-box">
            <center>
                <div class="main_div">
                    <span class="m-t-20" id="title-name1"><br><br><br>&nbsp;<b><?php echo $system_name; ?></b></span>
                    <br/><br/>
...
//           alert("dsgfjsdf");
    ...
    function Popup(data) {
        ...
        myWindow.document.write('<link rel="stylesheet" href="<?php echo base_url(); ?>assets/css/print_merit_certificate.css" type="text/css" /><style type="text/css"> .main_div{background-image: url("assets/images/teacher_certificate2.png"); width: 1300px; height: 880px; !important;}.print_text{font-size: 45px; !important;}</style>');
