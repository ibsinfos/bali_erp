...
<div class="col-md-12 white-box">
  ...
  <div class="col-md-12 white-box">
      <div class="col-md-4"><a href="#" onclick="PrintElem('#print');" class="fcbtn btn btn-danger btn-outline btn-1d"><?php echo get_phrase('print_attendance_sheet'); ?></a>
  </div>
  </div>
<div id="print">
    ...
    <table class="table table-bordered hidden-sm hidden-xs hidden-md">
        <thead>
            <tr>
                ...
                <?php } ?>
                <td class="text-center"><?php echo get_phrase("%");?></td>
           ...
           //pre($students); die();
            ...
            $min_per = $minimum_attendance;
                ...
                <tr>
                    ...
                    <td class="notification"><button onclick='send_notification("<?php echo $row['student_id'];?>","<?php echo round($percentage, 2);?>")' class="btn-red"><?php echo get_phrase("send"); ?></button></td>
                    <?php endforeach; ?>
                </tr>
            <?php ?>
        </tbody>
