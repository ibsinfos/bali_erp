...
<div class="row bg-title"> 
    ...
    <div class="col-lg-9 col-sm-8 col-md-8 col-xs-12">
        ...
        <ol class="breadcrumb">
            ...
            <li><a href="<?php echo base_url(); ?>index.php?school_admin/add_subject_online_exam/<?php echo $class_id.'/'.$exam_id;?>"><?php echo get_phrase('add_subject_online_exam'); ?></a></li>
...
<div class="row">
    ...
    <?php } ?>
    <?php echo form_open(base_url() . 'index.php?school_admin/add_question_online/create/' . $exam_id, array('class' => 'form-groups-bordered validate', 'enctype' => 'multipart/form-data', 'id' => 'addQuestionFrom', 'name' => 'addQuestion')); ?>
                ...
                <div class="tab-content col-md-12">
                    ...
                    <div class="row">
                        ...
                        <div class="col-sm-4 col-xs-12">
                            ...
                            <div class="form-group">
                                <input type="number" class="form-control" id="order" name="order"  placeholder="Order" required="required"  value="<?= set_value('order') ?>" >
                        ...
                        <div class="col-sm-4 col-xs-12">
                            ...
                            <div class="form-group">
                                <select class="selectpicker" data-style="form-control" data-live-search="true" name="difficulty_level" data-validate="required" required="required" data-message-required ="Please select difficult level" >
                    ...
                    <div class="btn_for_sm" id="button_show2" style="display:none;">   
                        <button type="submit" class="btn btn-primary tab_btn"><?php echo get_phrase('add_question'); ?></button>
                    </div>
                </div>
            </div>
        </div>
