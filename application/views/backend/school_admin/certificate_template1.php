...
<style>
 .main_div{
    /*border-radius: 25px;*/
    background: url('assets/images/ceritificate1.png');
    width: 1000px;
    height: 950px; 
...
//                jQuery('#subject_holder').append(response);
    ...
    function Popup(data) {
        ...
        myWindow.document.write('<link rel="stylesheet" href="<?php echo base_url(); ?>assets/css/print_merit_certificate.css" type="text/css" /><style type="text/css"> .main_div{ background: url("assets/images/ceritificate1.png"); width:900px; height:700px; background-size :100% 100%;}</style>');
