...
<div class="row">
    ...
    <div class=" col-xs-12 col-md-4 hidden-xs p-l-20">
        ...
        <div class="mail-sidebar-row" data-step="5" data-intro="On click of new message,write new message page will appear" data-position='top'>
            <a href="<?php echo base_url(); ?>index.php?school_admin/school_admin_message/school_admin_message_new" class="btn btn-danger btn-icon btn-block">
                            ...
                            <ul class="chatonline style-none list-unstyled">
                                ...
                                foreach ($message_threads as $row):
                                    ...
                                    if ($user_to_show_type == "admin") {
                                        $unread_message_number = $this->crud_model->count_unread_message_of_thread_main($row['message_thread_code']);
                                        ?>
                                        <li>
                                            <a href="<?php echo base_url(); ?>index.php?school_admin/school_admin_message/school_admin_message_read/<?php echo $row['message_thread_code']; ?>" style="padding:12px;">
    ...
    <?php } endforeach; ?>
                    ...
                    <section id="section-flip-2">
                        ...
                        <div class="chat-left-inner">
                            ...
                            <ul class="chatonline style-none list-unstyled">
                                <?php
                                $current_user = "school_admin" . '-' . $this->session->userdata('login_user_id');
