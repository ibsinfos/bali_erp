<div class="tab-pane box active" id="edit" style="padding: 5px">
    <div class="box-content">
        ...
        <?php echo form_open(base_url() . 'index.php?school_admin/class_routine/do_update/'.$row['class_routine_id'] , array('class' => 'form-horizontal validatable','target'=>'_top'));?>
                <div class="form-group">
                    <label class="col-sm-3 control-label"><?php echo get_phrase('class');?></label>
                    <div class="col-sm-5">
                        <select id="class_id" name="class_id" class="selectpicker1" data-style="form-control" data-live-search="true" onchange="section_subject_select(this.value , <?php echo $param2;?>)">
                            <?php 
                ...
                <div class="form-group">
                    ...
                    <div class="col-sm-5">
                        <select name="day" class="selectpicker1" data-style="form-control" data-live-search="true">
                ...
                <div class="form-group">
                    ...
                    <div class="col-sm-9">
                        ...
                        ?>
                        <div class="col-md-3">
                            <select name="time_start" class="selectpicker1" data-style="form-control" data-live-search="true">
                        ...
                        <div class="col-md-3">
                            <select name="time_start_min" class="selectpicker1" data-style="form-control" data-live-search="true">
                        ...
                        <div class="col-md-3">
                            <select name="starting_ampm" class="selectpicker1" data-style="form-control" data-live-search="true">
                ...
                <div class="form-group">
                    ...
                    <div class="col-sm-9">
                        ...
                        ?>
                        <div class="col-md-3">
                            <select name="time_end" class="selectpicker1" data-style="form-control" data-live-search="true">
                            <option value=""><?php echo get_phrase('hour');?></option>
                                <?php for($i = 0; $i <= 12 ; $i++):?>
                        ...
                        <div class="col-md-3">
                            <select name="time_end_min" class="selectpicker1" data-style="form-control" data-live-search="true">
                            <option value=""><?php echo get_phrase('minutes');?></option>
                                <?php for($i = 0; $i <= 11 ; $i++):?>
                        ...
                        <div class="col-md-3">
                            <select name="ending_ampm" class="selectpicker1" data-style="form-control" data-live-search="true">
...
<script type="text/javascript">
    function section_subject_select(class_id , class_routine_id) {
       // alert(class_id +'||||||||||'+ class_routine_id);
        $.ajax({
            url: '<?php echo base_url();?>index.php?school_admin/section_subject_edit/' + class_id + '/' + class_routine_id ,
            success: function(response)
            { 
                jQuery('#section_subject_edit_holder').html(response).selectpicker('refresh');
            }
        });
    }
</script>
...
<script type="text/javascript">
    $(document).ready(function() { //alert('sdsd');
        var class_id = $('#class_id option:checked').val();
