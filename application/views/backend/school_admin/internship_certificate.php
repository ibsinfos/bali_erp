...
if (!empty($certificate_detail)) {
        ...
        $from_Date = $certificate_detail->from_Date;
...
<div id="div2">
       ...
       <div class="font_size3"><i>The internship was conducted between</i> &nbsp;<input type="text" class="input_val" id="join_date" name="from_Date" data-step="6" data-intro="Please write join date" data-position='right' value="<?php echo $from_Date; ?>"><span id="join_date_val" class="print_text"><?php echo $from_Date; ?></span> &nbsp;to &nbsp; <input type="text" class="input_val" id="end_date" data-step="7" data-intro="Please write end date" data-position='right' name="to_date" value="<?php echo $to_date; ?>"><span id="end_date_val" class="print_text"><?php echo $to_date; ?></span> &nbsp;</div>
   <div class="col-md-12">&nbsp;</div>
