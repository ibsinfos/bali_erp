    ...
    <div class="col-md-8">
        <div class="panel panel-primary" data-collapsed="0">
            ...
            <div class="panel-body">
                ...
                <?php echo form_open(base_url() . 'index.php?school_admin/student/create/', array('class' => 'form-horizontal form-groups-bordered validate', 'enctype' => 'multipart/form-data')); ?>
                ...
                <div class="form-group">
                    ...
                    <div class="col-sm-5">
                        <select name="parent_id" class="form-control select2" data-validate="required" id="parent_id" data-message-required="<?php echo get_phrase('value_required'); ?>">
                ...
                <div class="form-group">
                    <label for="field-2" class="col-sm-3 control-label"><?php echo get_phrase('Card ID'); ?></label>

                    <div class="col-sm-5">
                        <input type="text" class="form-control" name="card_id" value="" >
                    </div> 
                </div>
                <div class="form-group">
