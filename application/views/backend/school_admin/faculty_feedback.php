<div class="row bg-title">
    ...
    <div class="col-lg-9 col-sm-8 col-md-8 col-xs-12">
        ...
        <ol class="breadcrumb">
            ...
            <li><?php echo get_phrase('communication'); ?>
                <ul>                    
                    <li><a href="<?php echo base_url(); ?>index.php?school_admin/noticeboard"><?php echo get_phrase('noticeboard'); ?></a></li>
                    <li><a href="<?php echo base_url(); ?>index.php?school_admin/campus_updates_management"><?php echo get_phrase('campus_update'); ?></a></li>
                    <li><a href="<?php echo base_url(); ?>index.php?school_admin/event_management"><?php echo get_phrase('event_management'); ?></a></li>
                    <li><a href="<?php echo base_url(); ?>index.php?school_admin/view_faculty_feedback"><?php echo get_phrase('faculty_feedback'); ?></a></li>
                    <li><a href="<?php echo base_url(); ?>index.php?school_admin/custom_message"><?php echo get_phrase('custom_message'); ?></a></li>
                </ul>
            </li>
            <li class="active">
                <?php echo $page_title; ?>
...
<div class="panel panel-danger block6" data-step="5" data-intro="For Information" data-position='bottom'>
    <div class="panel-heading">Dear Parent / Guardian,
                ...
                <div class="col-sm-6 form-group">
                    ...
                    <select data-style="form-control" data-live-search="true" class="selectpicker" name="teacher_id" id="teacher">
                        ...
                        <?php foreach ($teacher_list as $list): ?>
                            <option value = "<?php echo $list['teacher_id']; ?>"><?php echo $list['name'] ." ". ($list['middle_name']!=''?$list['middle_name']:'') ." ". $list['last_name']; ?></option><?php endforeach; ?>
                    </select>
