<?php foreach ($edit_data as $data): ?>
    <div class="row">
        <div class="col-md-12">
            <div><a href="javascript: void(0);" onclick="showAjaxModal('<?php echo base_url(); ?>index.php?modal/popup/modal_add_subjects/gpa');">
            ...
            <div class="panel-body">
                <?php echo form_open(base_url() . 'index.php?school_admin/gpa_subjects/do_update/' . $data['gpa_subject_id'], array('id' => 'subject_add', 'class' => 'form-horizontal form-groups-bordered validate', 'target' => '_top')); ?>
                <table class="table table-hover manage-u-table">
                    ...
                    <tbody>
                        <tr>
                            ...
                            <td><input type="text"  name="selected_weekly_classes" id="weekly<?php echo $data['subject_id']; ?>" value="<?php echo $data['weekly_classes']; ?>" class="form-control" onkeypress="return isNumber(event)" required/>
                            </td>
                            <td><input type="text"  name="selected_credit_hours" id="credit<?php echo $data['subject_id']; ?>" value="<?php echo $data['credit_hours']; ?>" class="form-control" onkeypress="return isNumber(event)" required/>
                            </td>
                            <td>                                            
