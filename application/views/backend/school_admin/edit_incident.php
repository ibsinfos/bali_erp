            ...
            <div class="row">
                <div class="col-md-6 form-group">
                 <label for="field-1">
                    ...
                    <select name="violation_type" id="violation_type" class="selectpicker" data-style="form-control" data-live-search="true"
                ...
                <div class="col-md-6 form-group">
                    ...
                    <label class="form-check-label"><input class="form-check-input" <?php echo $row['parent_appeal'] && ($row['parent_appeal']=="yes")?'checked':''?> type="radio" name="parent_appeal" id="parent_appeal_yes" required="required" value="yes"><?php echo "Yes"; ?></label>
                    <label class="form-check-label"><input class="form-check-input" <?php echo $row['parent_appeal'] && ($row['parent_appeal']=="no")?'checked':''?> type="radio" name="parent_appeal" id="parent_appeal_no" required="required" value="no"><?php echo "No"; ?></label>
                </div>
                <div class="col-md-6 form-group" id="parent_statement_display">
                    ...
                    <div class="input-group">
                        ...
                        <input type="text" class="form-control" id="parent_statement"  name="parent_statement" value="<?php echo $row['parent_statement']; ?>" placeholder="Parent Statement" data-validate="required" data-message-required ="<?php echo get_phrase('plesae_enter_the_parent_statement'); ?>">
                ...
                <div class="col-md-6 form-group">
                    ...
                    <div class="input-group">
                        ...
                        <input id= "date_of_occurrence" type="text" class="form-control mydatepicker"  name="date_of_occurrence" value="<?php echo date('d-m-Y',strtotime($row['date_of_occurrence'])); ?>" placeholder="Pick a date" required="required" data-validate="required" data-message-required ="Please pick a date">
                    </div>  
                </div>
                <div class="col-md-6 form-group">
