...
<div class="row m-0">
    <div class="col-md-12  white-box">
        ...
        <div class="col-md-4 form-group text-center" data-step="5" data-intro="<?php echo get_phrase('Transfer Certificate Genereate');?>" data-position='right'>
        ...
        <div class="col-md-4 form-group text-center" data-step="6" data-intro="<?php echo get_phrase('Merit Certificate Generate');?>" data-position='right'>
...
<!--        <div class="col-md-3 form-group" data-step="7" data-intro="<?php // echo get_phrase('New Certificate create here.');?>" data-position='right'>
        ...
        <div class="col-md-4 form-group text-center" data-step="8" data-intro="<?php echo get_phrase('Upload Documents from here.');?>" data-position='left'>
