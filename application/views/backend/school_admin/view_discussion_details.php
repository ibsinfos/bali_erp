        ...
        <div class="row well p-l-0 p-r-0 blog_box">
            ...
            <div class="col-md-12">
                <div class="col-md-1 pull-left">
                    ...
                    <img src="<?php echo ($teacher_image!=" "?"uploads/teacher_image/".$teacher_image:"uploads/user.png");?>" width="60" height="60"/>
                    <?php }else if($details[0]['discussion_usertype'] == 'admin'){ ?>
                    
                    <img src="<?php echo ($image!=" "?"uploads/admin_image/".$image:"uploads/user.png");?>" width="60" height="60"/>
...
<div class="col-md-12">
    <div class="well col-xs-12">
        <div class="col-xs-1 text-left">
            <img src="<?php echo ($admin_image!=" "?"uploads/admin_image/".$admin_image:"uploads/user.png");?>" width="60" height="60"/>
        </div>
            ...
            <div class="col-md-12 p-10 white-box">
                <div class="media">
                    ...
                    <?php if(isset($post['sub_comments'])){  
                             if(isset($post['sub_comments']['image'])){
                                $image = $post['sub_comments']['image'];?>  
                    <div class="media">
                        <div class="media-left">                   
                            
                            <?php if($post['sub_comments']['user_type'] == 'teacher'){ ?>
                            <img src="<?php echo ($image!=" "?"uploads/teacher_image/".$image:"uploads/user.png");?>" width="60" height="60"/>
                            <?php }else if($post['sub_comments']['user_type'] == 'admin'){ ?>
                            <img src="<?php echo ($image!=" "?"uploads/admin_image/".$image:"uploads/user.png");?>" width="60" height="60"/>
                            <?php } else if($post['sub_comments']['user_type'] == 'student'){ ?>
                            <img src="<?php echo ($image!=" "?"uploads/student_image/".$image:"uploads/user.png");?>" width="60" height="60"/>
                            <?php }else if($post['sub_comments']['user_type'] == 'parent'){ ?>
                            <img src="<?php echo ($image!=" "?"uploads/parent_image/".$image:"uploads/user.png");?>" width="60" height="60"/>
                            <?php }?>                            
