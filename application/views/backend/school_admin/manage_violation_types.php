...
<div class="row">
    <div class="col-md-12">
        <a href="<?php echo base_url(); ?>index.php?disciplinary/add_violation_types" class="btn btn-primary btn-circle btn-lg pull-right tooltip-danger" data-toggle="tooltip" data-placement="left" title="" data-original-title="Create Violation Type" data-step="5" data-intro="From here you can create a new violation type" data-position='left'>
...
<table class= "custom_table table display" cellspacing="0" width="100%" id="ex">
    <thead>
        <tr>
            ...
            <th><div><?php echo get_phrase('violation_types'); ?></div></th>
