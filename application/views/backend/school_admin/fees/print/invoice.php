    ...
    <div>   
        ...
        <div id="customer" style=" margin-top:3px !important;">
            <table id="meta" class="marg-top-fif">
                ...
                <tr>
                    <td style="height: 15px;" class="meta-head"><?php echo get_phrase('status')?></td>
                    <td style="height: 15px;"><?php echo $invoice->is_paid?get_phrase('paid'):get_phrase('unpaid');?></td>
                </tr>
                <tr>
        ...
        <div style="margin:15px 0 0 0 !important; padding: 0px !important;">
            ...
            <tr>
                <td colspan="3">
                    <table width="100%">
                        <tr>
                            <td class="total-line balance" height="15"><?php echo get_phrase('total_amount'); ?></td>
                            <td class="total-value balance" align="right" height="15">
                                <div class="due"><?php echo sett('currency').' '.$invoice->total_amt?></div>
                            </td>
                        </tr>
                    </table>
                </td>
