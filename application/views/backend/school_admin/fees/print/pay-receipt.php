...
<title><?php echo 'PAYMENT RECEIPT';?> <?php echo $receipt->receipt_no; ?></title>
            ...
            <table id="meta" class="marg-top-fif">
                <tr >
                    <td rowspan="6" style="border: 1px solid white; max-height: 25px; border-right: 1px solid black; text-align: left" width="42%">
                        ...
                        <?php echo $student->city;?> <?php echo $student->state;?> <?php echo $student->zip_code;?> <br>
                        <?php //echo $student->country; ?> <br>
                        <?php echo $student->class_name;?>
                    </td>
                    <td class="meta-head" style="height: 15px;"><?php echo $print_type.' No.';?></td>
                    <td style="height: 15px;"><?php echo sett('system_title').'/'.$receipt->running_year.'/'.$receipt->receipt_no;?></td>
                </tr>
                <tr>
                    <td class="meta-head" style="height: 15px;"><?php echo 'Enroll Code.';//$_L['Due Date']; ?></td>
                    <td style="height: 15px;"><?php echo $student->enroll_code;//$studentEnroleCode;//date($config['df'], strtotime($d['duedate']));?></td>
                </tr>
                <tr>
                    <td style="height: 15px;" class="meta-head"><?php echo $print_type.' Date'; ?></td>
                    <td style="height: 15px;"><?php echo date('d/m/Y',strtotime($receipt->pay_date))?></td>
                </tr>
                <tr>
                    <td style="height: 15px;" class="meta-head"><?php echo 'Mode of Payment'; ?></td>
                    <td style="height: 15px;"><?php echo $receipt->pay_method?></td>
                </tr>
            </table>
        </div>
                    ...
                    <table width="100%">
                        <tr>
                            ...
                            <td class="total-value" align="right" height="15">
                                <div class="due"><?php echo sett('currency').' '.$receipt->net_amount?></div>
                            </td>
                            <td class="total-line" align="right" height="15"><?php echo get_phrase('previous_payment'); ?>:</td>
                            <td class="total-value" align="right" height="15">
                                <div id="subtotal"><?php echo sett('currency').' '.$receipt->previous_amount?></div>
                            </td>
                        </tr>
                        <tr>
                            <td  class="total-line" align="right" height="15"><?php echo get_phrase('paid_amount')?></td>
                            <td class="total-value" align="right" height="15">
                                <div class="due"><?php echo sett('currency').' '.$receipt->paid_amount;?></div>
                            </td>
                            ...
                            <td class="total-value balance" align="right" height="15">
                                <div class="due"><?php echo sett('currency').' '.$receipt->due_amount?></div>
                            </td>
                        </tr>
                    </table>
                </td>
