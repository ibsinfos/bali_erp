...
<head>
    ...
    <title><?php echo 'INVOICE RECEIPT';?></title>
        ...
        <table width="100%">
            <tr>
                ...
                <td style="border: 0;  text-align: right" width="37%">
                    <div id="logo" style="font-size:18px"><?php echo sett('address');?></div>
                </td>
            </tr>
        </table>
        <hr>
            ...
            <table id="meta">
                <tr>
                    <td rowspan="5" style="border: 1px solid white; border-right: 1px solid black; text-align: left" width="42%">
                        ...
                        <?php echo !empty($student->parent_phone)?'Phone: '. $student->parent_phone. ' <br>':'';?>
                        <?php echo !empty($student->parent_email)?'Email: '. $student->parent_email. ' <br>':'';?>
                    </td>
                    <td class="meta-head"><?php echo $rcpt.' No'; ?> #</td>
                </tr>
                <tr>
                    <td class="meta-head"><?php echo 'Enroll Code';//$_L['Due Date']; ?></td>
                    <td><?php echo $student->enroll_code;//date($config['df'], strtotime($d['duedate'])); ?></td>
                </tr>
                <tr>
                ...
                <tr>
                    ...
                    <td><?php echo date('d/m/Y', strtotime($inv_date));?></td>
                </tr>
                <?php /*<tr>
        ...
        <table id="items">
            ...
            <tr>
                ...
                <td class="total-value txt-right">
                    <div class="due"><?php echo sett('currency');?> <?php echo $total_amt;?></div>
                </td>
            </tr>

            <tr>
                <td class="blank">&nbsp;</td>
                <td colspan="2">Cashier  / Manager </td>
            </tr>
        </table>
        </br>
