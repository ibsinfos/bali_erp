                ...
                <div class="receipt-header">
                    ...
                    <div class="institution_header">
                        ...
                        <p class="institution_address">
                            ...
                            <?php echo $student->city;?> <?php echo $student->region;?> <?php echo $student->zip_code;?>
                        </p>
                    </div>
                </div>
                    ...
                    <table class="student-details">
                        <tbody>
                            <tr>
                                ...
                                <td class="bold rtl_bracket_fix right-label"><?php echo $student->student_fname.' '.$student->student_lname?></td>
                            </tr>
                            
                            <tr>
                                <td class="left-label">Parent:</td>
                                <td class="right-label"><?php echo $student->parent_fname.' '.$student->parent_lname;?></td>
                            </tr>
