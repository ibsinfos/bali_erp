    ...
    <div class="sidebar-nav slimscrollsidebar">
        ...
        <ul class=" nav p-r-0" id="side-menu">
            <li class="p-0 menu-item-tile">
                <a href="<?php echo base_url(); ?>index.php?fees/<?php echo $account_type; ?>/dashboard" class="waves-effect active menu-items text-center">
...
<?php
$arrModule = $this->session->userdata('arrAllLinks'); //pre($this->session->userdata); die;
