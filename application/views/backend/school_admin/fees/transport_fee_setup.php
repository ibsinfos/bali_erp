...
<div class="row bg-title">
    ...
    <div class="col-lg-3 col-md-4 col-sm-4 col-xs-12">
        <h4 class="page-title"><?php echo get_phrase('transport_fee_setup'); ?> </h4></div>
    <!-- /.page title -->
    <!-- .breadcrumb -->
...
<div class="row m-0">
    <div class="col-md-12 white-box">
        <?php echo form_open(base_url('index.php?fees/main/transport_fee_setup/'), array('class'=>'form-horizontal form-groups-bordered validate', 
        'target' => '_top','id'=>'form')); ?>
            <div class="row">
                            ...
                            <div class="input-group">
                                ...
                                <select name="fee_term_id" class="selectpicker" data-style="form-control" data-live-search="true" data-title="<?php echo get_phrase('select_term');?>">
                                    <?php foreach($fee_terms as $fterm){
                                            if(in_array($fterm->id,$transport_term_setting)){?>
...
$(document).on('change','select[name=fee_term_id]',function (e) {
    ...
    $.ajax({type:'post',  
            url: '<?php echo base_url('index.php?fees/main/ajax_get_transport_fee_detail')?>', 
