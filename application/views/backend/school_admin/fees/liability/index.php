    ...
    <div class="col-md-12 white-box">
        <div class="sttabs tabs-style-flip">
            <nav>
                <ul>
                    <li class="active">
                        <a href="#list" class="sticon fa fa-list"><span class="hidden-xs"><?php echo get_phrase('liability_list'); ?></span></a>
                    </li>
                    <li>
                        <a href="#add" class="sticon fa fa-plus-circle">
                            <span class="hidden-xs"><?php echo get_phrase('add_liability'); ?></span>
                        </a>
                    </li>
                </ul>
            </nav>
    ...
    <?php echo form_open(base_url().'index.php?fees/liability/add'); if($this->session->flashdata('flash_message_error')) {?><div class="alert alert-danger"><?php echo $this->session->flashdata('flash_message_error'); ?></div><?php }?>
                    ...
                    <div class="row">
                        <div class="col-sm-12 form-group text-center"><br>
                            <button type="submit" class="fcbtn btn btn-danger btn-outline btn-1d"><?php echo get_phrase("add_liability");?></button> 
                        </div>
                    </div>
                <?php echo form_close();?>                            
                </section>                
