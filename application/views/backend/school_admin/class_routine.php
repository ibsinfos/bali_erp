        ...
        <br>
            ...
            <br><br>
                <div class="box-content">
                    <?php echo form_open(base_url() . 'index.php?school_admin/class_routine/create' , array('class' => 'form-horizontal form-groups validate','target'=>'_top'));?>
                            <div class="form-group">
                                <label class="col-sm-3 control-label"><?php echo get_phrase('class');?></label>
                                <div class="col-sm-5">
                                    <select name="class_id" class="selectpicker" data-style="form-control" data-live-search="true" style="width:100%;"
                            ...
                            <div class="form-group">
                                ...
                                <div class="col-sm-5">
                                    <select name="day" class="selectpicker" data-style="form-control" data-live-search="true" style="width:100%;">
                            ...
                            <div class="form-group">
                                ...
                                <div class="col-sm-9">
                                    <div class="col-md-3">
                                        <select name="time_start" class="selectpicker" data-style="form-control" data-live-search="true">
                                    ...
                                    <div class="col-md-3">
                                        <select name="time_start_min" class="selectpicker" data-style="form-control" data-live-search="true">
                                    ...
                                    <div class="col-md-3">
                                        <select name="starting_ampm" class="selectpicker" data-style="form-control" data-live-search="true">
                            ...
                            <div class="form-group">
                                ...
                                <div class="col-sm-9">
                                    <div class="col-md-3">
                                        <select name="time_end" class="selectpicker" data-style="form-control" data-live-search="true">
                                            <option value=""><?php echo get_phrase('hour');?></option>
                                            <?php for($i = 0; $i <= 12 ; $i++):?>
                                                <option value="<?php echo $i;?>"><?php echo $i;?></option>
                                            <?php endfor;?>
                                    ...
                                    <div class="col-md-3">
                                        <select name="time_end_min" class="selectpicker" data-style="form-control" data-live-search="true">
                                            <option value=""><?php echo get_phrase('minutes');?></option>  
                                            <?php for($i = 0; $i <= 11 ; $i++):?>
                                                <option value="<?php echo $i * 5;?>"><?php echo $i * 5;?></option>
                                            <?php endfor;?>
                                    ...
                                    <div class="col-md-3">
                                        <select name="ending_ampm" class="selectpicker" data-style="form-control" data-live-search="true">
                                            <option value="1">am</option>
                                            <option value="2">pm</option>
                                        </select>
                                    </div>
