...
<?php echo form_open(base_url() . 'index.php?school_admin/student_promotion/promote',array('id'=>'promotion-form')); ?>
    <div class="col-md-12 white-box" data-step="6" data-intro="<?php echo get_phrase('From here by filling information you can manage the promotion. After filling the mandatory fields click on manage promotion button. Then you will get a list of students.');?>" data-position='top'>
        <?php $running_year_array = explode("-", $running_year);
        ...
        <div class="col-sm-4 form-group">
            <label><?php echo get_phrase('current_session'); ?></label>
        ...
        <div class="col-sm-4 form-group">
            <label><?php echo get_phrase('promote_to_session');?></label>
            <select name="promotion_year" class="selectpicker" data-style="form-control" data-live-search="true" id="promotion_year">
        ...
        <div class="col-sm-4 form-group">
            <label><?php echo get_phrase('promote_from_class'); ?><span class="error mandatory"> *</span></label>
        ...
        <div class="col-sm-4 form-group">
            <label><?php echo get_phrase('promote_from_section'); ?><span class="error mandatory"> *</span></label>
        ...
        <div class="col-sm-4 form-group">
            <label><?php echo get_phrase('promote_to_class'); ?><span class="error mandatory"> *</span></label>
            ...
            <span class="col-md-12" id="set_fee_link" class='mandantory'></span>
        </div>

        <div class="col-sm-4 form-group">
            <label><?php echo get_phrase('promote_to_section'); ?><span class="error mandatory"> *</span></label>
        ...
        <div class="col-sm-12 text-right">
            <button class="fcbtn btn btn-danger btn-outline btn-1d" type="button" onclick="get_students_to_promote('<?php echo $running_year; ?>')">
