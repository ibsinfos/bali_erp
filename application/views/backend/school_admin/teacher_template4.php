...
//                jQuery('#subject_holder').append(response);
    ...
    function Popup(data) {
        ...
        myWindow.document.write('<link rel="stylesheet" href="<?php echo base_url(); ?>assets/css/print_merit_certificate.css" type="text/css" /><style type="text/css"> .main_div{background-image: url("assets/images/teacher_certificate4.png"); width: 1024px; height: 740px; !important;}.print_text{font-size: 45px; !important;}</style>');
