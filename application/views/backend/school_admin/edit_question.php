    ...
    <div class="col-lg-9 col-sm-8 col-md-8 col-xs-12">
        ...
        <ol class="breadcrumb">
            <li><a href="<?php echo base_url(); ?>index.php?school_admin/dashboard"><?php echo get_phrase('Dashboard'); ?></a></li>
             <li><a href="<?php echo base_url(); ?>index.php?school_admin/add_subject_online_exam/<?php echo $class_id.'/'.$exam_id.'/'.$row['subject_id'];?>"><?php echo get_phrase('subject_online_exam'); ?></a></li>
...
<div class="row">
    ...
    <?php } ?>
    <?php echo form_open(base_url().'index.php?school_admin/add_question_online/edit/do_update/'.$row['id'], array('class' => 'form-groups-bordered validate', 'enctype' => 'multipart/form-data', 'id' => 'addQuestionFrom','name' => 'addQuestion')); ?>
    ...
    <div class="col-md-12">        
        <div class="panel panel-primary" data-collapsed="0">
            ...
            <div class="row">
                ...
                <div class="col-md-12"><div class="panel panel-primary" data-collapsed="0"><?php echo get_phrase('question_type'); ?></div></div>
                <div class="col-md-12"> 
                    <div class="col-md-3">  
                        <label class="form-check-label">
                        <?php if($row['qtype_id']=='1')$chk1 = 'checked="checked"';else $chk1="";?>
                            <input class="form-check-input" type="radio" 
                                   name="question_type" id="question_type" value="1" <?php echo $chk1; ?> onclick="show_tabs_list();"  >
                ...
                <div class="tab-content col-md-12">
                        ...
                        <div class="row">                            
                            <div class="col-xs-12">
                                <label for="field-1"><?php echo get_phrase('answer1'); ?>
                                    <span class="error" style="color: red;"> *</span></label>
                                <div class="form-group">
                                    <textarea class="form-control" rows="5" name="answer1" placeholder="Enter your Answer" data-validate="required" data-message-required ="Please enter your answer2 "><?php echo $row['option1']; ?></textarea>
                                </div>
                            </div>
                        </div>
                        ...
                        <div class="row">
                            <div class="col-xs-12">
                                <label for="field-1"><?php echo get_phrase('answer2'); ?>
                                    <span class="error" style="color: red;"> *</span></label>
                                <div class="form-group">
                                    <textarea class="form-control" rows="5" name="answer2" placeholder="Enter your Answer" data-validate="required" data-message-required ="Please enter your Answer "><?php echo $row['option2']; ?></textarea>
                        ...
                        <div class="row">
                            ...
                            <div class="col-xs-12">
                                <label for="field-1"><?php echo get_phrase('answer3'); ?>
                                    <span class="error" style="color: red;"> *</span></label>
                                <div class="form-group">
                                    <textarea class="form-control" rows="5" name="answer3" placeholder="Enter your Answer" data-validate="required" data-message-required ="Please enter your Answer "><?php echo $row['option3']; ?></textarea>
                        ...
                        <div class="row">
                            <div class="col-xs-12">
                                <label for="field-1"><?php echo get_phrase('answer2'); ?>
                                    <span class="error" style="color: red;"> *</span></label>
                                <div class="form-group">
                                    <textarea class="form-control" rows="5" name="answer4" placeholder="Enter your Answer" data-validate="required" data-message-required ="Please enter your Answer "><?php echo $row['option4']; ?></textarea>
                        ...
                        <div class="row">
                            <div class="col-xs-12">
                                <label for="field-1"><?php echo get_phrase('answer5'); ?>
                                    <span class="error" style="color: red;"> *</span></label>
                                <div class="form-group">
                                    <textarea class="form-control" rows="5" name="answer5" placeholder="Enter your Answer" data-validate="required" data-message-required ="Please enter your Answer "><?php echo $row['option5']; ?></textarea>
                        ...
                        <div class="row">
                            <div class="col-xs-12">
                                <label for="field-1"><?php echo get_phrase('answer6'); ?>
                                    <span class="error" style="color: red;"> *</span></label>
                                <div class="form-group">
                                    <textarea class="form-control" rows="5" name="answer6" placeholder="Enter your Answer" data-validate="required" data-message-required ="Please enter your Answer "><?php echo $row['option6']; ?></textarea>
                    ...
                    <div class="row">
                        <div class="col-sm-6 col-xs-12">
                            ...
                            <div class="form-group">
                                ...
                                <select class="selectpicker" data-style="form-control" data-live-search="true" required="required" data-validate="required" data-message-required ="Please select your subject " name="subject_id">
                        ...
                        <div class="col-sm-6 col-xs-12">
                            ...
                            <div class="form-group">
                                <input type="text" class="form-control" required="required" name="hint"  placeholder="Hint"  value="<?php echo $row['hint'];?>" >
                    ...
                    <div class="row">
                        <div class="col-sm-4 col-xs-12">
                            ...
                            <div class="form-group">
                                <input type="number" class="form-control" name="marks" required="required"  placeholder="Marks"  value="<?php echo $row['marks'];?>" >
                        ...
                        <div class="col-sm-4 col-xs-12">
                            ...
                            <div class="form-group">
                                <input type="number" class="form-control" required="required" name="negative_marks"  placeholder="Negative Marks"  value="<?php echo $row['negative_marks'];?>" >
                        ...
                        <div class="col-sm-4 col-xs-12">
                            ...
                            <div class="form-group">
                                ...
                                if($row['diff_id']=='1') 
                                    ...
                                    ?>
                                <select class="selectpicker" data-style="form-control" data-live-search="true" required="required" name="difficulty_level" data-validate="required" data-message-required ="Please select difficult level" >
