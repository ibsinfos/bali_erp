    ...
    <div class="col-md-12">        
        <div class="white-box">
                            ...
                            <table class="table table-hover manage-u-table table_edjust" id="example_cce">
                                ...
                                <tbody><?php $count = 1; if(count($subjects)){ foreach ($subjects as $row): ?>
                                    <tr>
                                        ...
                                        <td><?php echo $row['weekly_classes']; ?>
            ...
            <!----CREATION FORM STARTS---->
                        <section id="add">
                            <?php echo form_open(base_url() . 'index.php?school_admin/cce_subjects/'.$cce_class_id.'/add', array('id'=>'subject_add', 'class' => 'form-horizontal form-groups-bordered validate', 'target' => '_top')); ?>
