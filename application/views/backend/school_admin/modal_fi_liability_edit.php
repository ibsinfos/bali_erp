<div class="modal-body">
    ...
    <?php echo form_open(base_url() . 'index.php?fees/liability/update/'.$edit_data[0]['fi_liability_id'], array('class' => 'form-horizontal form-groups-bordered validate', 'target' => '_top')); ?>
