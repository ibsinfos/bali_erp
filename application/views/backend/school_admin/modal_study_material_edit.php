<?php if (!empty($study_material_info)) {
    ...
    <?php echo form_open(base_url() . 'index.php?school_admin/update_study_material/' . $row['document_id'], array('class' => 'validate', 'enctype' => 'multipart/form-data')); ?>
        <from class="form-horizontal form-material">
            <div class="form-group">            
                ...
                <div class="col-sm-12 m-b-20">
                    ...
                    <select class="selectpicker1" data-style="form-control" data-live-search="true" name="teacher_id">
                        <option value=""><?php echo get_phrase('select_class'); ?></option>
    <?php foreach ($teachers as $row2): ?>
                            <option value="<?php echo $row2['teacher_id']; ?>"<?php if ($row['teacher_id'] == $row2['teacher_id']) {
            echo 'selected';
    ...
    <?php endforeach; ?>
                ...
                <div class="col-md-12 text-right">
                    <button type="submit" class="fcbtn btn btn-danger btn-outline btn-1d" name="submit_changes"><?php echo get_phrase('submit_changes'); ?></button>
                </div>
