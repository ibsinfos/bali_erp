    ...
    <div class="row">
        <div class="col-md-12">
            <div class="panel-body content-wrap">
                <?php echo form_open(base_url() . 'index.php?school_admin/edit_holiday/' . $row['id'], array('class' => 'form-horizontal form-material form-groups-bordered validate', 'target' => '_top')); ?>
                <div class="row">          
                                ...
                                <div class="row">          
                                    <div class="col-xs-12 col-md-offset-3 col-md-6">
                                        ...
                                        <div class="input-group">
                                            ...
                                            <input type="text" required="required" class="form-control datepicker" name="date_start" value="<?php echo $row['date_start']; ?>"data-validate="required" data-message-required="<?php echo get_phrase('please_enter_required_value');?>"/>
