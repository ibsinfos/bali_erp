...
<div class="col-md-12 white-box">
    <?php echo form_open(base_url() . 'index.php?school_admin/manage_attendance/'); ?>
    <div class="row">
...
<div class="col-md-12 white-box" data-step="9" data-intro="<?php echo get_phrase('Shows the student details!!');?>" data-position='top'>
    <div class="text-center">
        <h3><?php echo get_phrase('attendance_for_class');?> <?php echo $class_name.'-'.get_phrase('section').' '.$section_name.' on '.date('d M Y', strtotime($date));?></h3>
    </div>
    ...
    <?php echo form_open(base_url('index.php?school_admin/attendance_update/' . $class_id . '/' . $section_id . '/' . $date)); ?>
                ...
                foreach($attendance as $att): 
                    ...
                    <tr style="<?php echo $time_st['style']?>">
                        ...
                        <td>
                            ...
                            data-class-id="<?php echo $att->class_id?>" 
                            data-section-id="<?php echo $att->section_id?>" 
            ...
            $.ajax({
                ...
                success:function(res){
                    ...
                    if(res.status=='success'){
                        //console.log(res,"\n");
                        //console.log(AtRec.data('stu-id'),rowIndex,AtRec.rowIndex,$($('#ex').dataTable().fnGetNodes()[AtRec.rowIndex])[0]);
