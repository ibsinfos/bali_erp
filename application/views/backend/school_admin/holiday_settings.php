                                ...
                                <table class= "custom_table table display"  id="example23">
                                    <thead>
                                        <tr>
                                            ...
                                            <th data-step="7" data-intro="<?php echo get_phrase('From here you can edit or delete a holiday.');?>" 
                                            data-position="top"><div><?php echo get_phrase('option'); ?></div></th>
                                        </tr>
                                    </thead>
                                    <tbody>
                                    <?php $n = 1;
                                        ...
                                        <tr>
                                            ...
                                            <td>
                                                ...
                                                if($holiday->date_end!='0000-00-00'){
                                                    echo date('Y-m-d', strtotime($holiday->date_end)); 
                                                }else{
                                                    echo date('Y-m-d', strtotime($holiday->date_start. ' + '.($holiday->number_of_days-1).' days'));
                                                }?>
                                            </td>

                                            <td>
                                                <input type="checkbox" class="toggleswith" id="holiday_<?php echo $holiday->id;?>"
                                                    <?php echo $holiday->is_active==1?'checked':''?> data-toggle="toggle">
                                            </td>

                                            <td>
                                                <!-- edit -->
                                                <a onclick="showAjaxModal('<?php echo base_url('index.php?modal/popup/modal_edit_holiday/'.$holiday->id)?>');">
                                                    <button type="button" class="btn btn-default btn-outline btn-circle btn-lg m-r-5 tooltip-danger" 
                                                    data-toggle="tooltip" data-placement="top" data-original-title="Edit Holiday" title="Edit Holiday">
                                                    <i class="fa fa-pencil-square-o"></i></button>
                                                </a>
                                                <!-- delete -->
                                                <a onclick="confirm_modal('<?php echo base_url('index.php?school_admin/delete_holiday/'.$holiday->id)?>');">
                                                    <button type="button" class="btn btn-default btn-outline btn-circle btn-lg m-r-5 tooltip-danger" 
                                                    data-toggle="tooltip" data-placement="top" data-original-title="Delete Holiday" title="Delete Holiday">
                            ...
                            <form class="form-horizontal form-groups-bordered validate" name='add_exam_form' id="add_exam_form" method="post" action="<?php echo base_url(); ?>index.php?school_admin/save_holiday_list/indian">
                                ...
                                <div class="row">          
                                    <div class="col-xs-12 col-md-offset-3 col-md-6">
                                        ...
                                        <div class="input-group">
                                            <div class="input-group-addon" id="start_date"><i class="fa fa-calendar"></i></div>
                                            <input type="text" required="required" class="form-control datepicker" name="date" data-validate="required" data-message-required="<?php echo get_phrase('please_enter_required_value');?>"/>
                                ...
                                <div class="row">          
                                    <div class="col-xs-12 col-md-offset-3 col-md-6">
                                        ...
                                        <div class="input-group">
                                            ...
                                            <input type="text" required="required" class="form-control datepicker" name="end_date" data-validate="required" data-message-required="<?php echo get_phrase('please_enter_required_value');?>"/>
                                ...
                                <!-- <div class="row">          
                                    <div class="col-xs-12 col-md-offset-3 col-md-6">
                                        ...
                                        <div class="input-group">
                                            ...
                                            <input type="text" class="form-control" name="number_of_days" data-validate="required" 
                                ...
                                <div class="text-right">
                                    <button type="submit" class="fcbtn btn btn-danger btn-outline btn-1d"> <?php echo get_phrase('add_holiday');?></button>
                                </div>
                            </form>
                            <!--CREATION FORM ENDS-->   
                        </section>
