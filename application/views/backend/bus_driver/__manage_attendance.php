<?php 
//    $year           =   explode('-', $running_year); //echo  $running_year; exit;
...
<?php echo form_open((@$mark_today?base_url('index.php?bus_driver/mark_attendance'):base_url('index.php?bus_driver/manage_attendance')));?>
<div class="col-md-12 white-box">
    ...
    <div class="col-sm-6 form-group" data-step="7" data-intro="Select a date from here!" data-position='top'>               
        ...
        <div class="input-group">
          ...
          <input type="text" class="form-control" id="today_date" name="timestamp" value="<?php echo date('d/m/Y');?>" <?php echo @$mark_today?'disabled':''?>>             
        </div>  
    ...
    <div class="text-right col-xs-12">
        <button type="submit" class="fcbtn btn btn-danger btn-outline btn-1d" data-step="8" data-intro="On the click of button, you will get a list of attendance." data-position='top'><?php echo get_phrase('MANAGE ATTENDANCE');?></button>
    </div> 
</div>
<?php echo form_close();?>
<script>
