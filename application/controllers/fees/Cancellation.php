...
class Cancellation extends CI_Controller {
    ...
    public function index() {
        ...
        $page_data['page_name'] = 'fees/cancellation_list';
        $page_data['page_title'] = get_phrase('manage_fee_cancellations');
    ...
    public function cancellation(){
        $page_data = $this->get_page_data_var();
        $page_data['page_name'] = 'fees/cancellation';
        $page_data['page_title'] = get_phrase('request_for_cancellation');
