...
<head>
    ...
    <script src="<?php echo base_url();?>gps/js/maps.js"></script>
    <script src="<?php echo base_url();?>gps/js/leaflet-0.7.5/leaflet.js"></script>
    <script src="<?php echo base_url();?>gps/js/leaflet-plugins/google.js"></script>
    <script src="<?php echo base_url();?>gps/js/leaflet-plugins/bing.js"></script>
    <link rel="stylesheet" href="<?php echo base_url();?>gps/js/leaflet-0.7.5/leaflet.css">    
    <!-- 
    ...
    -->
    <link rel="stylesheet" href="<?php echo base_url();?>gps/css/styles.css">
...
<body>
    <div class="container-fluid">
        ...
        <div class="row"><?php if($_SESSION['parent_id']==0){?>
