...
class reminder extends Home
{
    ...
    */
    public function reminders_data()
    {
        ...
        $select = array('circulation.id as id', 'member.name as name', 'member.type', 'member.id as member_id', 'member.email as email', 'member.mobile', 'book_info.title as title', 'issue_date', 'expire_date');
