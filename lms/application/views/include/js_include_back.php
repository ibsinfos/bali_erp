...
$j('document').ready(function() {
 ...
 if(selected=="Admin")
  var replace_dropdown='<select class="chosen-select" name="user_type" id="field-user_type"><option value=""></option><option value="Member">'+'<?php echo $this->lang->line("member level user"); ?>'+'</option><option value="Admin" selected="yes">'+'<?php echo $this->lang->line("admin level user"); ?>'+'</option></select>';  
  else
