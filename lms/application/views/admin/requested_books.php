    ...
    <div class="modal-dialog modal-sm" >
        <div class="modal-content" style="width:460px; border-radius: 6px; padding-top: 24px; padding-bottom: 8px;">                
            <div class="modal-body text-center">
                ...
                <input name='accept_req_id' id='accept_req_id' type='hidden' />
                <p class="debug-url"></p>
            </div>

            <div class="modal-footer">
                <button type="button" class="btn btn-default" data-dismiss="modal">No, cancel please!</button>
                <a id="submit_accept" class="btn btn-success btn-ok" onclick='accept_req'>Yes, Accept it!</a>
            </div>
        </div>
    </div>
</div>
  ...
  <div class="row" >
    <div class="col-xs-12">
        <div class="grid_container" style="width:100%;height:530px;">
            ...
            url="<?php echo base_url()."admin/requested_books_data"; ?>" 
...
<script> 
    ...
    function accept_req(e,req_id){
        ...
        $("#accept_req_id").val(req_id);
    } 

    $("#submit_accept").click(function(){
        var req_id=$("#accept_req_id").val();
        
        $.ajax({
            url:base_url+'admin/accept_action',
            type:'POST',
            data:{req_id:req_id},
            
            success:function(response){
                $("#confirm-accept").modal('hide');
    ...
    $("#submit_reject").click(function(){
        ...
        $.ajax({
            url:base_url+'admin/reject_action',
            type:'POST',
