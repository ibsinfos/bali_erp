    ...
    <ul class="sidebar-menu">
      ...
      <li class="treeview">
        <a href="#">
          ...
          <span><?php echo $this->lang->line('books');?></span>
        ...
        <ul class="treeview-menu">
          ...
          <li><a href="<?php echo site_url()."admin/book_list"; ?>"><i class="fa fa-book"></i> <span><?php echo $this->lang->line('books List');?></span></a></li>
        </ul>
      </li>
