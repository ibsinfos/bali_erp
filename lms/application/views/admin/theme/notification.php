...
<!--     <li class="dropdown messages-menu">
   ...
   -->
    ...
    <?php
    $pro_pic=base_url().'assets/images/profile_image/boy.png'; 
    if($this->session->userdata('profile_image')!=''){
      $pro_pic=base_url().'assets/images/profile_image/'.$this->session->userdata('profile_image');
    }
    ?>
    ...
    <li class="dropdown user user-menu">
      ...
      <ul class="dropdown-menu">
        ...
        <li class="user-header"> 
          <center><img src="<?php echo $pro_pic;?>" class="img-responsive img-thumbnail" width="120" height="120"/></center>
          <p>
        ...
        <li class="user-footer border_gray">
          <div class="pull-left">
            <a href="<?php echo site_url('admin/my_account') ?>" class="btn btn-info btn-flat"><?php echo $this->lang->line("my Account") ?></a>
          </div>
