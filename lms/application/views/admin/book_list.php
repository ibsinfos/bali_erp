...
<section class="content-header">
  <h1> <?php echo $this->lang->line("books"); ?> </h1>

</section>
<div id="div_for_print_book_ids"><?php if(isset($book_ids)) echo $book_ids; ?></div>
...
<script>  
    ...
    {               
        ...
        str=str+"&nbsp;&nbsp;&nbsp;&nbsp;<a style='cursor:pointer' title='"+'<?php echo $this->lang->line("delete") ?>'+"' data-href='"+delete_url+"' data-toggle='modal' data-target='#confirm-delete'>"+' <img src="<?php echo base_url("plugins/grocery_crud/themes/flexigrid/css/images/close.png");?>" alt="Delete">'+"</a>";
	...
	/*
		if(delete_permission == 1)
        str=str+"&nbsp;&nbsp;&nbsp;&nbsp;<a style='cursor:pointer' title='"+'<?php echo $this->lang->line("delete") ?>'+"' href='"+delete_url+"'>"+' <img src="<?php echo base_url("plugins/grocery_crud/themes/flexigrid/css/images/close.png");?>" alt="Delete" onClick="return doconfirm()">'+"</a>";
	...
	function doconfirm()
	{ 
		delete_book=confirm("Are you sure to delete permanently?");
		if(delete_book!=true)
		{
			return false;
		}
    ...
    <div class="modal-dialog modal-sm" >
        <div class="modal-content" style="width:460px; border-radius: 6px; padding-top: 24px; padding-bottom: 8px;">                
            <div class="modal-body text-center">
                <i class="material-icons" style="font-size:60px;color:#F8BB86"></i>
                <h1>Are you sure?.</h1>
