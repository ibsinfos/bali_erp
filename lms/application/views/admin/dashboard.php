				...
				<div class="row">
					...
					<div class="col-xs-12 col-sm-12 col-md-4 col-lg-4">
						...
						<div class="small-box bg-blue">
							...
							<a target="_blank" href="<?php echo base_url()."admin/book_list"; ?>" class="small-box-footer">
					...
					<div class="col-xs-12 col-sm-12 col-md-4 col-lg-4">
						...
						<div class="small-box bg-yellow">
							...
							<a target="_blank" href="<?php echo base_url()."admin/circulation"; ?>" class="small-box-footer">
								<?php echo $this->lang->line('more information');?> <i class="fa fa-arrow-circle-right"></i>
							</a>
						</div>
					</div>
					...
					<div class="col-xs-12 col-sm-12 col-md-4 col-lg-4">
						...
						<div class="small-box bg-aqua">
							...
							<a target="_blank" href="<?php echo base_url()."admin/config_member"; ?>" class="small-box-footer">
								<?php echo $this->lang->line('more information');?> <i class="fa fa-arrow-circle-right"></i>
							</a>
						</div>
					</div>
				...
				<div class="row">
					...
					<div class="col-xs-12 col-sm-12 col-md-3 col-xs-12 col-sm-12 col-md-3 col-lg-3">
						...
						<div class="small-box bg-blue">
							...
							<a target="_blank" href="<?php echo base_url()."admin/today_added_book"; ?>" class="small-box-footer">
								<?php echo $this->lang->line('more information');?> <i class="fa fa-arrow-circle-right"></i>
							</a>
						</div>
					</div>
					...
					<div class="col-xs-12 col-sm-12 col-md-3 col-xs-12 col-sm-12 col-md-3 col-lg-3">
						...
						<div class="small-box bg-yellow">
							...
							<a target="_blank" href="<?php echo base_url()."admin/today_issue_book"; ?>" class="small-box-footer">
								<?php echo $this->lang->line('more information');?> <i class="fa fa-arrow-circle-right"></i>
							</a>
						</div>
					</div>
					...
					<div class="col-xs-12 col-sm-12 col-md-3 col-xs-12 col-sm-12 col-md-3 col-lg-3">
						...
						<div class="small-box bg-aqua">
							...
							<a target="_blank" href="<?php echo base_url()."admin/today_return_book"; ?>" class="small-box-footer">
								<?php echo $this->lang->line('more information');?> <i class="fa fa-arrow-circle-right"></i>
							</a>
						</div>
					</div>
