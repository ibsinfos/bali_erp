...
<section class="content">  
  <div class="row">
    <div class="col-xs-12">
        <div class="grid_container" style="width:100%; height:530px;">
            <table
            id="tt"  
            ...
            >
                ...
                <thead>
				    <tr>
                        ...
                        <th width="50px" field="title" sortable="true" ><?php echo $this->lang->line("title");?></th>
           ...
           <a class="btn btn-warning"  title="Add Book" href="<?php echo site_url('admin/add_circulation');?>">
            ...
            <form class="form-inline" style="margin-top:20px">
                <div class="form-group">
                    <input id="book_id" name="book_id" class="form-control" size="10" placeholder="<?php echo $this->lang->line("book id");?>">
                </div> 

                <div class="form-group">
                    <input id="name" name="name" class="form-control" size="13" placeholder="<?php echo $this->lang->line("member name");?>">
                </div>   

                <div class="form-group">
                    <input id="book_title" name="book_title" class="form-control" size="13" placeholder="<?php echo $this->lang->line("title");?>">
                </div>

                <div class="form-group">
                    <input id="author" name="author" class="form-control" size="13" placeholder="<?php echo $this->lang->line("author");?>">
                </div> 
                ...
                <div class="form-group">
                    <input id="from_date" name="from_date" class="form-control datepicker" size="13" placeholder="<?php echo $this->lang->line("issue from date");?>">
                </div>

                 <div class="form-group">
                    <input id="to_date" name="to_date" class="form-control  datepicker" size="13" placeholder="<?php echo $this->lang->line("issue to date");?>">
                </div>   
