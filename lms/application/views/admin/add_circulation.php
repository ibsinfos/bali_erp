...
<div class="row">
  ...
  <div class="col-xs-12  col-sm-12 col-md-8 col-md-offset-2 col-lg-6 col-lg-offset-3" style="margin-top:0px;background-color:#EEE;padding:10px;">
    ...
    <div class="col-xs-10 col-sm-10 col-md-10 col-lg-10">
      <form class="form" role="form" action="<?php echo site_url().'admin/add_circulation_action';?>"  method = "post" style="padding-left:15px;" id="SearchMember">
...
<script type="text/javascript">
  $('#book_id').on('change', function() {
    ...
    $('#book_id').on('keypress', function(e) {
        if(e.keyCode == 13){
            var book_name = $(this).val();
