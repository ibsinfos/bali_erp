				...
				<div class="box-body">
					...
					<div class="form-group">
						...
						<div class="col-sm-9 col-md-6 col-lg-6">
							<input name="book_title" value="<?php if(isset($info['book_title'])) echo $info['book_title']; else { echo set_value('book_title');}?>"  class="form-control" type="text-area">		          
					...
					<div class="form-group">
						...
						<div class="col-sm-9 col-md-6 col-lg-6">
							<input name="author" value="<?php if(isset($info['author'])) echo $info['author']; else { echo set_value('author');}?>"  class="form-control" type="text">		               
					...
					<div class="form-group">
						...
						<div class="col-sm-9 col-md-6 col-lg-6">
							<input name="edition" value="<?php if(isset($info['edition'])) echo $info['edition']; else { echo set_value('edition');}?>"  class="form-control" type="text-area">		          
					...
					<div class="form-group">
						...
						<div class="col-sm-9 col-md-6 col-lg-6">
							<input name="note" value="<?php if(isset($info['note'])) echo $info['note']; else { echo set_value('note');}?>"  class="form-control" type="text-area">		          
