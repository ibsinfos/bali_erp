        ...
        <div class="grid_container" style="width:100%; height:500px;">
            ...
            <thead>
                <tr>  
                    ...
                    <th width="50px"field="title" sortable="true" ><?php echo $this->lang->line("message subject"); ?></th> 
                    <th width="50px" field="message" sortable="true" ><?php echo $this->lang->line("message"); ?></th> 
