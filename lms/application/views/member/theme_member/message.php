<?php 
	...
	{		
        ...
        if($this->session->flashdata('success_custom') != '')
        {
           echo "<div class='alert alert-success text-center'><h4 style='margin:0;'><i class='fa fa-check-circle'></i> ".$this->session->flashdata('success_custom')."</h4></div>";
        }
