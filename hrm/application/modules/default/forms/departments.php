...
//        $bunitdata = $bunitModel->fetchAll('isactive=1 '.$where,'unitname');
...
//		}
		...
		$this->addElements(array($id,$deptname,$deptcode,$description,$start_date,$country,$state,$city,$address1,$address2,$address3,$timezone,$depthead,$submit));
