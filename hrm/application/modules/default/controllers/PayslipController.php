...
class Default_PayslipController extends Zend_Controller_Action
{
    ...
    {   
        $payslipmodel = new Default_Model_Payslip(); echo 'uhiuhi'; die;
		...
		if($refresh == 'refresh')
		{
			...
			$sort = 'DESC';$by = 'modified_date';$pageNo = 1;$searchData = '';$searchQuery = '';	
			$searchArray = array();
		}
		else 
		{
			$sort = ($this->_getParam('sort') !='')? $this->_getParam('sort'):'DESC';
			$by = ($this->_getParam('by')!='')? $this->_getParam('by'):'modified_date';
			if($dashboardcall == 'Yes')
		...
		$dataTmp = $payslipmodel->getGrid($sort,$by,$perPage,$pageNo,$searchData,$call,$dashboardcall);	
//		print_r($dataTmp);die("here");
   ...
   public function addpopupAction()
	...
	{	
        ...
        public function runpayroll_byfreq() {
            $pay_freq_id    =   $this->getRequest()->getParam('pay_freq_id');
