...
//					}
   ...
   /*	Medical claims validations */
    ...
    public function emppayslipAction() {
        $auth = Zend_Auth::getInstance();
        if ($auth->hasIdentity()) {
            $loginUserId = $auth->getStorage()->read()->id;
        }
        ...
        //echo '<pre>';print_r($salarySlipDetails);exit;
        //sapp_Payrollcal::pre($earningColArr);die;
        ...
        //sapp_Payrollcal::pre($netPayDetails);die;
        if(!empty($netPayDetails)){
            $this->view->is_generated="yes";
