...
class Zend_View_Helper_Employeedetails extends Zend_View_Helper_Abstract {
	...
	public  function employeetabs($conText,$userId)
	{
		...
		else if($conText == "mydetails")
		{
			...
			if(!empty($empOrganizationTabs) && in_array("emp_payslip", $empOrganizationTabs))
			$tabsHtml .= '<li id = "emp_payslip"><a href="'.BASE_URL.'mydetails/emppayslip">'.TAB_EMP_PAYSLIP.'</a></li>';
